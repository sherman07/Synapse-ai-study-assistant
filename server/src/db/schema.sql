...
CREATE TABLE IF NOT EXISTS broadcast_jobs (
  ...
  style VARCHAR(80) NOT NULL DEFAULT 'calm_study_narrator',
  ...
  tts_provider VARCHAR(80) NOT NULL DEFAULT 'openai',
  tts_model VARCHAR(120) NOT NULL DEFAULT 'gpt-4o-mini-tts',
  plan_json JSON NULL,
