...
const Nk = (() => {
  ...
  return a && !(Zy(e) && n !== r && a === l) ? a : t === "file:" || Zy(e) && n !== r ? s : `${t}//${window.location.host}`;
})();
...
function Ik() {
  ...
  const t = Gi();
  try {
    const r = (e = t.localStorage) == null ? void 0 : e.getItem(Ky);
    if (r) return r;
    const s = Yy();
    return (n = t.localStorage) == null || n.setItem(Ky, s), s;
  } catch {
    return Yy();
  }
}
...
class N_ {
  ...
  async requestHeaders(e = {}) {
    var a, l, c;
    const n = Gi(), r = Dk(e);
    r["X-Synapse-Client-Id"] = Li(Ik(), 160);
  ...
  async fetch(e, n = {}) {
    ...
    try {
      ...
      throw (d = c == null ? void 0 : c.signal) != null && d.aborted ? new Gy(this.timeoutMessage(l), { cause: p }) : new Gy(
        [
...
function jk() {
  ...
  var M = Array.isArray, P = Object.prototype.hasOwnProperty, $ = { current: null }, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function O(F, D, X) {
    var ae, me = {}, _e = null, ke = null;
    if (D != null) for (ae in D.ref !== void 0 && (ke = D.ref), D.key !== void 0 && (_e = "" + D.key), D) P.call(D, ae) && !I.hasOwnProperty(ae) && (me[ae] = D[ae]);
  ...
  return ve.Children = { map: ge, forEach: function(F, D, X) {
    ...
    if (D != null) {
      ...
      for (De in D) P.call(D, De) && !I.hasOwnProperty(De) && (ae[De] = D[De] === void 0 && Te !== void 0 ? Te[De] : D[De]);
    }
...
var Qy;
function Fh() {
  return Qy || (Qy = 1, Od.exports = jk()), Od.exports;
}
var E = Fh();
const Kn = /* @__PURE__ */ I_(E), Oh = /* @__PURE__ */ Ek({
  __proto__: null,
  default: Kn
}, [E]);
...
function Fk() {
  return Xy || (Xy = 1, (function(t) {
    ...
    function M(W) {
      if (S = !1, C(W), !w) if (n(f) !== null) w = !0, ce(P);
      else {
        var J = n(m);
    ...
    t.unstable_IdlePriority = 5, t.unstable_ImmediatePriority = 1, t.unstable_LowPriority = 4, t.unstable_NormalPriority = 3, t.unstable_Profiling = null, t.unstable_UserBlockingPriority = 2, t.unstable_cancelCallback = function(W) {
      ...
      return D = Q + D, W = { id: g++, callback: J, priorityLevel: W, startTime: Q, expirationTime: D, sortIndex: -1 }, Q > F ? (W.sortIndex = Q, e(m, W), n(f) === null && W === n(m) && (S ? (A(O), O = -1) : S = !0, fe(M, Q - F))) : (W.sortIndex = D, e(f, W), w || v || (w = !0, ce(P))), W;
...
var Jy;
function Ok() {
  return Jy || (Jy = 1, zd.exports = Fk()), zd.exports;
}
/**
 * @license React
...
` + y[k].replace(" at new ", " at ");
  ...
  function Ku(i, o) {
    return i == null || i === "http://www.w3.org/1999/xhtml" ? sm(o) : i === "http://www.w3.org/2000/svg" && o === "foreignObject" ? "http://www.w3.org/1999/xhtml" : i;
  }
  var ca, om = (function(i) {
  ...
  function lm(i, o) {
    ...
    for (var u in o) if (o.hasOwnProperty(u)) {
      var h = u.indexOf("--") === 0, y = am(u, o[u], h);
  ...
  function dm() {
    if (pi) {
      var i = pi, o = mi;
      if (mi = pi = null, um(i), o) for (i = 0; i < o.length; i++) um(o[i]);
    }
  }
  function fm(i, o) {
    return i(o);
  ...
  var Ms = !1, da = null, fa = !1, nc = null, FT = { onError: function(i) {
    Ms = !0, da = i;
  } };
  ...
  function zT(i) {
    ...
    for (var u = i, h = o; ; ) {
      ...
      if (y.child === x.child) {
        for (x = y.child; x; ) {
          if (x === u) return gm(y), i;
          if (x === h) return gm(y), o;
          x = x.sibling;
        }
        throw Error(n(188));
      }
  ...
  function ym(i) {
    return i = zT(i), i !== null ? vm(i) : null;
  }
  function vm(i) {
  ...
  var _m = e.unstable_scheduleCallback, xm = e.unstable_cancelCallback, $T = e.unstable_shouldYield, VT = e.unstable_requestPaint, Ge = e.unstable_now, BT = e.unstable_getCurrentPriorityLevel, rc = e.unstable_ImmediatePriority, Sm = e.unstable_UserBlockingPriority, ha = e.unstable_NormalPriority, UT = e.unstable_LowPriority, wm = e.unstable_IdlePriority, pa = null, wn = null;
  function HT(i) {
  ...
  var km, ac, bm, Cm, Pm, lc = !1, va = [], Xn = null, Jn = null, er = null, Is = /* @__PURE__ */ new Map(), Ds = /* @__PURE__ */ new Map(), tr = [], QT = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
  function Em(i, o) {
    switch (i) {
      case "focusin":
      case "focusout":
  ...
  function Mm(i) {
    ...
    if (o !== null) {
      ...
      if (u !== null) {
        if (o = u.tag, o === 13) {
          if (o = mm(u), o !== null) {
            i.blockedOn = o, Pm(i.priority, function() {
              bm(u);
            });
            return;
          }
  ...
  function JT() {
    lc = !1, Xn !== null && _a(Xn) && (Xn = null), Jn !== null && _a(Jn) && (Jn = null), er !== null && _a(er) && (er = null), Is.forEach(Rm), Ds.forEach(Rm);
  }
  function Fs(i, o) {
    i.blockedOn === o && (i.blockedOn = null, lc || (lc = !0, e.unstable_scheduleCallback(e.unstable_NormalPriority, JT)));
  }
  function Os(i) {
    function o(y) {
      return Fs(y, i);
    ...
    for (; 0 < tr.length && (u = tr[0], u.blockedOn === null); ) Mm(u), u.blockedOn === null && tr.shift();
  }
  ...
  function uc(i, o, u, h) {
    if (xa) {
      var y = cc(i, o, u, h);
      if (y === null) Cc(i, o, h, Sa, u), Em(i, h);
      else if (XT(y, i, o, u, h)) h.stopPropagation();
      else if (Em(i, h), o & 4 && -1 < QT.indexOf(i)) {
        for (; y !== null; ) {
          var x = Ys(y);
          if (x !== null && km(x), x = cc(i, o, u, h), x === null && Cc(i, o, h, Sa, u), x === y) break;
          y = x;
        }
  ...
  function $t(i) {
    function o(u, h, y, x, k) {
      ...
      return this.isDefaultPrevented = (x.defaultPrevented != null ? x.defaultPrevented : x.returnValue === !1) ? Aa : Dm, this.isPropagationStopped = Dm, this;
    }
  ...
  }, defaultPrevented: 0, isTrusted: 0 }, fc = $t(yi), Ls = Q({}, yi, { view: 0, detail: 0 }), nA = $t(Ls), hc, pc, zs, ka = Q({}, Ls, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: gc, button: 0, buttons: 0, relatedTarget: function(i) {
  ...
  } }), jm = $t(ka), rA = Q({}, ka, { dataTransfer: 0 }), iA = $t(rA), sA = Q({}, Ls, { relatedTarget: 0 }), mc = $t(sA), oA = Q({}, yi, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), aA = $t(oA), lA = Q({}, yi, { clipboardData: function(i) {
    return "clipboardData" in i ? i.clipboardData : window.clipboardData;
  } }), uA = $t(lA), cA = Q({}, yi, { data: 0 }), Fm = $t(cA), dA = {
    Esc: "Escape",
    Spacebar: " ",
    Left: "ArrowLeft",
    Up: "ArrowUp",
  ...
  var mA = Q({}, Ls, { key: function(i) {
  ...
  } }), gA = $t(mA), yA = Q({}, ka, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), Om = $t(yA), vA = Q({}, Ls, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: gc }), _A = $t(vA), xA = Q({}, yi, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), SA = $t(xA), wA = Q({}, ka, {
    deltaX: function(i) {
    ...
    deltaZ: 0,
    deltaMode: 0
  }), TA = $t(wA), AA = [9, 13, 27, 32], yc = c && "CompositionEvent" in window, $s = null;
  c && "documentMode" in document && ($s = document.documentMode);
  var kA = c && "TextEvent" in window && !$s, Lm = c && (!yc || $s && 8 < $s && 11 >= $s), zm = " ", $m = !1;
  function Vm(i, o) {
    switch (i) {
      case "keyup":
  ...
  function bA(i, o) {
    switch (i) {
      case "compositionend":
        return Bm(o);
      case "keypress":
        return o.which !== 32 ? null : ($m = !0, zm);
      case "textInput":
        return i = o.data, i === zm && $m ? null : i;
      default:
        return null;
    }
  }
  function CA(i, o) {
    if (vi) return i === "compositionend" || !yc && Vm(i, o) ? (i = Im(), wa = dc = nr = null, vi = !1, i) : null;
    switch (i) {
      case "paste":
        return null;
      case "keypress":
        ...
        return null;
      case "compositionend":
        return Lm && o.locale !== "ko" ? null : o.data;
      default:
        return null;
    }
  }
  ...
  function Hm(i, o, u, h) {
    cm(h), o = Ma(o, "onChange"), 0 < o.length && (u = new fc("onChange", "change", null, u, h), i.push({ event: u, listeners: o }));
  }
  var Vs = null, Bs = null;
  function EA(i) {
    lg(i, 0);
  ...
  if (c) {
    ...
    if (c) {
      ...
      if (!_c) {
        ...
        Zm.setAttribute("oninput", "return;"), _c = typeof Zm.oninput == "function";
      }
      vc = _c;
    } else vc = !1;
    Wm = vc && (!document.documentMode || 9 < document.documentMode);
  }
  function Gm() {
    Vs && (Vs.detachEvent("onpropertychange", Km), Bs = Vs = null);
  }
  function Km(i) {
    if (i.propertyName === "value" && ba(Bs)) {
      var o = [];
      Hm(o, Bs, i, Xu(i)), pm(EA, o);
    }
  }
  function RA(i, o, u) {
    i === "focusin" ? (Gm(), Vs = o, Bs = u, Vs.attachEvent("onpropertychange", Km)) : i === "focusout" && Gm();
  }
  function NA(i) {
  ...
  function FA(i) {
    var o = Xm(), u = i.focusedElem, h = i.selectionRange;
    if (o !== u && u && u.ownerDocument && Qm(u.ownerDocument.documentElement, u)) {
      if (h !== null && xc(u)) {
        if (o = h.start, i = h.end, i === void 0 && (i = o), "selectionStart" in u) u.selectionStart = o, u.selectionEnd = Math.min(i, u.value.length);
          ...
          h = h.end === void 0 ? x : Math.min(h.end, y), !i.extend && x > h && (y = h, h = x, x = y), y = qm(u, x);
          var k = qm(
            u,
            h
          );
  ...
  var OA = c && "documentMode" in document && 11 >= document.documentMode, _i = null, Sc = null, Hs = null, wc = !1;
  function Jm(i, o, u) {
  ...
  var xi = { animationend: Ca("Animation", "AnimationEnd"), animationiteration: Ca("Animation", "AnimationIteration"), animationstart: Ca("Animation", "AnimationStart"), transitionend: Ca("Transition", "TransitionEnd") }, Tc = {}, eg = {};
  c && (eg = document.createElement("div").style, "AnimationEvent" in window || (delete xi.animationend.animation, delete xi.animationiteration.animation, delete xi.animationstart.animation), "TransitionEvent" in window || delete xi.transitionend.transition);
  function Pa(i) {
    if (Tc[i]) return Tc[i];
    if (!xi[i]) return i;
    var o = xi[i], u;
    for (u in o) if (o.hasOwnProperty(u) && u in eg) return Tc[i] = o[u];
    return i;
  }
  var tg = Pa("animationend"), ng = Pa("animationiteration"), rg = Pa("animationstart"), ig = Pa("transitionend"), sg = /* @__PURE__ */ new Map(), og = "abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");
  function rr(i, o) {
    sg.set(i, o), a(o, [i]);
  }
  for (var Ac = 0; Ac < og.length; Ac++) {
    var kc = og[Ac], LA = kc.toLowerCase(), zA = kc[0].toUpperCase() + kc.slice(1);
    rr(LA, "on" + zA);
  }
  rr(tg, "onAnimationEnd"), rr(ng, "onAnimationIteration"), rr(rg, "onAnimationStart"), rr("dblclick", "onDoubleClick"), rr("focusin", "onFocus"), rr("focusout", "onBlur"), rr(ig, "onTransitionEnd"), l("onMouseEnter", ["mouseout", "mouseover"]), l("onMouseLeave", ["mouseout", "mouseover"]), l("onPointerEnter", ["pointerout", "pointerover"]), l("onPointerLeave", ["pointerout", "pointerover"]), a("onChange", "change click focusin focusout input keydown keyup selectionchange".split(" ")), a("onSelect", "focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")), a("onBeforeInput", ["compositionend", "keypress", "textInput", "paste"]), a("onCompositionEnd", "compositionend focusout keydown keypress keyup mousedown".split(" ")), a("onCompositionStart", "compositionstart focusout keydown keypress keyup mousedown".split(" ")), a("onCompositionUpdate", "compositionupdate focusout keydown keypress keyup mousedown".split(" "));
  ...
  function Zs(i) {
    if (!i[Ea]) {
      i[Ea] = !0, r.forEach(function(u) {
        u !== "selectionchange" && ($A.has(u) || bc(u, !1, i), bc(u, !0, i));
      });
      ...
      if ((o & 7) === 0) {
        e: {
          ...
          if ((te || Z) && (Z = G.window === G ? G : (Z = G.ownerDocument) ? Z.defaultView || Z.parentWindow : window, te ? (se = u.relatedTarget || u.toElement, te = B, se = se ? jr(se) : null, se !== null && (Ke = Dr(se), se !== Ke || se.tag !== 5 && se.tag !== 6) && (se = null)) : (te = null, se = B), te !== se)) {
            ...
            te !== null && cg(K, Z, te, le, !1), se !== null && Ke !== null && cg(K, Ke, se, le, !0);
          }
        }
        e: {
          if (Z = B ? Ti(B) : window, te = Z.nodeName && Z.nodeName.toLowerCase(), te === "select" || te === "input" && Z.type === "file") var ue = MA;
          else if (Um(Z)) if (Wm) ue = DA;
          else {
            ue = NA;
            var he = RA;
          }
        ...
        switch (he = B ? Ti(B) : window, i) {
          case "focusin":
            (Um(he) || he.contentEditable === "true") && (_i = he, Sc = B, Hs = null);
            break;
          case "focusout":
            Hs = Sc = _i = null;
            break;
        ...
        else vi ? Vm(i, u) && (ye = "onCompositionEnd") : i === "keydown" && u.keyCode === 229 && (ye = "onCompositionStart");
        ye && (Lm && u.locale !== "ko" && (vi || ye !== "onCompositionStart" ? ye === "onCompositionEnd" && vi && (pe = Im()) : (nr = G, dc = "value" in nr ? nr.value : nr.textContent, vi = !0)), he = Ma(B, ye), 0 < he.length && (ye = new Fm(ye, i, null, u, G), K.push({ event: ye, listeners: he }), pe ? ye.data = pe : (pe = Bm(u), pe !== null && (ye.data = pe)))), (pe = kA ? bA(i, u) : CA(i, u)) && (B = Ma(B, "onBeforeInput"), 0 < B.length && (G = new Fm("onBeforeInput", "beforeinput", null, u, G), K.push({ event: G, listeners: B }), G.data = pe));
      }
      lg(K, o);
    });
  }
...
`).replace(BA, "");
  ...
  var Rc = typeof setTimeout == "function" ? setTimeout : void 0, UA = typeof clearTimeout == "function" ? clearTimeout : void 0, fg = typeof Promise == "function" ? Promise : void 0, HA = typeof queueMicrotask == "function" ? queueMicrotask : typeof fg < "u" ? function(i) {
    return fg.resolve(null).then(i).catch(WA);
  } : Rc;
  function WA(i) {
    setTimeout(function() {
      throw i;
  ...
  var wi = Math.random().toString(36).slice(2), Tn = "__reactFiber$" + wi, Ks = "__reactProps$" + wi, On = "__reactContainer$" + wi, Ic = "__reactEvents$" + wi, ZA = "__reactListeners$" + wi, GA = "__reactHandles$" + wi;
  function jr(i) {
    var o = i[Tn];
    if (o) return o;
    for (var u = i.parentNode; u; ) {
      if (o = u[On] || u[Tn]) {
        if (u = o.alternate, o.child !== null || u !== null && u.child !== null) for (i = hg(i); i !== null; ) {
          if (u = i[Tn]) return u;
          i = hg(i);
        }
        return o;
  ...
  function gg(i, o, u) {
    ...
    u ? (i = mg(i, o, Fr), h.__reactInternalMemoizedMergedChildContext = i, Ie(bt), Ie(pt), Me(pt, i)) : Ie(bt), Me(bt, u);
  }
  ...
  function ar() {
    if (!jc && Ln !== null) {
      ...
      try {
        ...
        throw Ln !== null && (Ln = Ln.slice(i + 1)), _m(rc, ar), y;
      } finally {
        Ae = o, jc = !1;
      }
    }
    ...
    if (je) {
      ...
      if (o) {
        ...
        if (!xg(i, o)) {
          ...
          o = ir(u.nextSibling);
          var h = Vt;
          o && xg(i, o) ? _g(h, u) : (i.flags = i.flags & -4097 | 2, je = !1, Vt = i);
        }
      } else {
        if (Lc(i)) throw Error(n(418));
  ...
  function za(i) {
    if (i !== Vt) return !1;
    if (!je) return Sg(i), je = !0, !1;
    var o;
    if ((o = i.tag !== 3) && !(o = i.tag !== 5) && (o = i.type, o = o !== "head" && o !== "body" && !Mc(i.type, i.memoizedProps)), o && (o = Bt)) {
      if (Lc(i)) throw wg(), Error(n(418));
      for (; o; ) _g(i, o), o = ir(o.nextSibling);
    }
    if (Sg(i), i.tag === 13) {
  ...
  function Ag(i) {
    ...
    function N(z, j, V, Y) {
      var ue = V.type;
      return ue === I ? G(z, j, V.props.children, Y, V.key) : j !== null && (j.elementType === ue || typeof ue == "object" && ue !== null && ue.$$typeof === ce && Tg(ue) === j.type) ? (Y = y(j, V.props), Y.ref = qs(z, j, V), Y.return = z, Y) : (Y = cl(V.type, V.key, V.props, null, z.mode, Y), Y.ref = qs(z, j, V), Y.return = z, Y);
    }
    function B(z, j, V, Y) {
            ...
            e: {
              for (var ue = V.key, he = j; he !== null; ) {
                if (he.key === ue) {
                  ...
                  } else if (he.elementType === ue || typeof ue == "object" && ue !== null && ue.$$typeof === ce && Tg(ue) === he.type) {
  ...
  var Ei = Ag(!0), kg = Ag(!1), Va = sr(null), Ba = null, Mi = null, Vc = null;
  function Bc() {
    Vc = Mi = Ba = null;
  }
  function Uc(i) {
  ...
  var Za = M.ReactCurrentDispatcher, Qc = M.ReactCurrentBatchConfig, Vr = 0, ze = null, et = null, it = null, Ga = !1, eo = !1, to = 0, qA = 0;
  function mt() {
    throw Error(n(321));
  }
  function Xc(i, o) {
  ...
  function Jc(i, o, u, h, y, x) {
    if (Vr = x, ze = o, o.memoizedState = null, o.updateQueue = null, o.lanes = 0, Za.current = i === null || i.memoizedState === null ? ek : tk, i = u(h, y), eo) {
      x = 0;
      do {
  ...
  function Ng(i, o) {
    ...
    if (x && (h.memoizedState = y, Pt = !0), h = h.queue, rd(jg.bind(null, u, h, i), [i]), h.getSnapshot !== o || x || it !== null && it.memoizedState.tag & 1) {
      if (u.flags |= 2048, ro(9, Dg.bind(null, u, h, y, o), void 0, null), st === null) throw Error(n(349));
      (Vr & 30) !== 0 || Ig(u, o, y);
    }
    return y;
  }
  ...
  function Dg(i, o, u, h) {
    o.value = u, o.getSnapshot = h, Fg(o) && Og(i);
  }
  function jg(i, o, u) {
    return u(function() {
      Fg(o) && Og(i);
  ...
  function Hg(i, o, u) {
    return u = u != null ? u.concat([i]) : null, Ya(4, 4, Ug.bind(null, o, i), u);
  }
  function id() {
  }
  function Wg(i, o) {
  ...
  function Gg(i, o, u) {
    return (Vr & 21) === 0 ? (i.baseState && (i.baseState = !1, Pt = !0), i.memoizedState = u) : (fn(u, o) || (u = Tm(), ze.lanes |= u, Br |= u, i.baseState = !0), o);
  }
  function QA(i, o) {
    var u = Ae;
    Ae = u !== 0 && 4 > u ? u : 4, i(!0);
  ...
  function XA(i, o, u) {
    var h = hr(i);
    if (u = { lane: h, action: u, hasEagerState: !1, eagerState: null, next: null }, Yg(i)) qg(o, u);
    else if (u = bg(i, o, u, h), u !== null) {
      var y = St();
      yn(u, i, h, y), Qg(u, o, h);
    }
  }
  function JA(i, o, u) {
    ...
    if (Yg(i)) qg(o, y);
      ...
      u = bg(i, o, y, h), u !== null && (y = St(), yn(u, i, h, y), Qg(u, o, h));
    }
  }
  function Yg(i) {
    var o = i.alternate;
  ...
  var qa = { readContext: Jt, useCallback: mt, useContext: mt, useEffect: mt, useImperativeHandle: mt, useInsertionEffect: mt, useLayoutEffect: mt, useMemo: mt, useReducer: mt, useRef: mt, useState: mt, useDebugValue: mt, useDeferredValue: mt, useTransition: mt, useMutableSource: mt, useSyncExternalStore: mt, useId: mt, unstable_isNewReconciler: !1 }, ek = { readContext: Jt, useCallback: function(i, o) {
  ...
  }, useContext: Jt, useEffect: $g, useImperativeHandle: function(i, o, u) {
  ...
  }, useState: Lg, useDebugValue: id, useDeferredValue: function(i) {
    ...
    return y.queue = x, $g(jg.bind(
      null,
      h,
      x,
      i
    ), [i]), h.flags |= 2048, ro(9, Dg.bind(null, h, x, u, o), void 0, null), u;
  }, useId: function() {
    ...
    useDeferredValue: function(i) {
      var o = en();
      return Gg(o, et.memoizedState, i);
    },
    useTransition: function() {
  ...
  }, nk = { readContext: Jt, useCallback: Wg, useContext: Jt, useEffect: rd, useImperativeHandle: Hg, useInsertionEffect: Vg, useLayoutEffect: Bg, useMemo: Zg, useReducer: nd, useRef: zg, useState: function() {
    return nd(no);
  }, useDebugValue: id, useDeferredValue: function(i) {
    var o = en();
    return et === null ? o.memoizedState = i : Gg(o, et.memoizedState, i);
  }, useTransition: function() {
    var i = nd(no)[0], o = en().memoizedState;
    return [i, o];
  }, useMutableSource: Rg, useSyncExternalStore: Ng, useId: Kg, unstable_isNewReconciler: !1 };
  function pn(i, o) {
    if (i && i.defaultProps) {
...
` + x.stack;
  ...
  function xt(i, o, u, h) {
    o.child = i === null ? kg(o, null, u, h) : Ei(o, i.child, u, h);
  }
  ...
  function ay(i, o, u, h, y) {
    if (i === null) {
      var x = u.type;
      return typeof x == "function" && !Md(x) && x.defaultProps === void 0 && u.compare === null && u.defaultProps === void 0 ? (o.tag = 15, o.type = x, ly(i, o, x, h, y)) : (i = cl(u.type, null, h, o, o.mode, y), i.ref = o.ref, i.return = o, o.child = i);
    }
  ...
  function dy(i, o, u, h, y) {
    ...
    if (Ri(o, y), o.stateNode === null) Ja(i, o), Jg(o, u, h), od(o, u, h, y), h = !0;
    else if (i === null) {
      ...
      K || typeof k.UNSAFE_componentWillReceiveProps != "function" && typeof k.componentWillReceiveProps != "function" || (R !== h || N !== B) && ey(o, k, h, B), lr = !1;
      var Z = o.memoizedState;
      k.state = Z, Ha(o, h, k, y), N = o.memoizedState, R !== h || Z !== N || bt.current || lr ? (typeof G == "function" && (sd(o, u, G, h), N = o.memoizedState), (R = lr || Xg(o, u, R, h, Z, N, B)) ? (K || typeof k.UNSAFE_componentWillMount != "function" && typeof k.componentWillMount != "function" || (typeof k.componentWillMount == "function" && k.componentWillMount(), typeof k.UNSAFE_componentWillMount == "function" && k.UNSAFE_componentWillMount()), typeof k.componentDidMount == "function" && (o.flags |= 4194308)) : (typeof k.componentDidMount == "function" && (o.flags |= 4194308), o.memoizedProps = h, o.memoizedState = N), k.props = h, k.state = N, k.context = B, h = R) : (typeof k.componentDidMount == "function" && (o.flags |= 4194308), h = !1);
    } else {
      k = o.stateNode, Cg(i, o), R = o.memoizedProps, B = o.type === o.elementType ? R : pn(o.type, R), k.props = B, K = o.pendingProps, Z = k.context, N = u.contextType, typeof N == "object" && N !== null ? N = Jt(N) : (N = Ct(u) ? Fr : pt.current, N = ki(o, N));
      var te = u.getDerivedStateFromProps;
      (G = typeof te == "function" || typeof k.getSnapshotBeforeUpdate == "function") || typeof k.UNSAFE_componentWillReceiveProps != "function" && typeof k.componentWillReceiveProps != "function" || (R !== K || Z !== N) && ey(o, k, h, N), lr = !1, Z = o.memoizedState, k.state = Z, Ha(o, h, k, y);
      var se = o.memoizedState;
      R !== K || Z !== se || bt.current || lr ? (typeof te == "function" && (sd(o, u, te, h), se = o.memoizedState), (B = lr || Xg(o, u, B, h, Z, se, N) || !1) ? (G || typeof k.UNSAFE_componentWillUpdate != "function" && typeof k.componentWillUpdate != "function" || (typeof k.componentWillUpdate == "function" && k.componentWillUpdate(h, se, N), typeof k.UNSAFE_componentWillUpdate == "function" && k.UNSAFE_componentWillUpdate(h, se, N)), typeof k.componentDidUpdate == "function" && (o.flags |= 4), typeof k.getSnapshotBeforeUpdate == "function" && (o.flags |= 1024)) : (typeof k.componentDidUpdate != "function" || R === i.memoizedProps && Z === i.memoizedState || (o.flags |= 4), typeof k.getSnapshotBeforeUpdate != "function" || R === i.memoizedProps && Z === i.memoizedState || (o.flags |= 1024), o.memoizedProps = h, o.memoizedState = se), k.props = h, k.state = se, k.context = N, h = B) : (typeof k.componentDidUpdate != "function" || R === i.memoizedProps && Z === i.memoizedState || (o.flags |= 4), typeof k.getSnapshotBeforeUpdate != "function" || R === i.memoizedProps && Z === i.memoizedState || (o.flags |= 1024), h = !1);
    }
  ...
  function cd(i, o, u, h, y, x) {
    cy(i, o);
    var k = (o.flags & 128) !== 0;
    if (!h && !k) return y && gg(o, u, !1), Un(i, o, x);
    h = o.stateNode, ik.current = o;
    var R = k && typeof u.getDerivedStateFromError != "function" ? null : h.render();
    return o.flags |= 1, i !== null && k ? (o.child = Ei(o, i.child, null, x), o.child = Ei(o, null, R, x)) : xt(i, o, R, x), o.memoizedState = h.state, y && gg(o, u, !0), o.child;
  }
  function fy(i) {
    var o = i.stateNode;
    o.pendingContext ? pg(i, o.pendingContext, o.pendingContext !== o.context) : o.context && pg(i, o.context, !1), Gc(i, o.containerInfo);
  }
  function hy(i, o, u, h, y) {
  ...
  function sk(i, o, u, h, y, x, k) {
    ...
    return y.data === "$?" ? (o.flags |= 128, o.child = i.child, o = vk.bind(null, i), y._reactRetry = o, null) : (i = x.treeContext, Bt = ir(y.nextSibling), Vt = o, je = !0, hn = null, i !== null && (Qt[Xt++] = zn, Qt[Xt++] = $n, Qt[Xt++] = Or, zn = i.id, $n = i.overflow, Or = o), o = hd(o, h.children), o.flags |= 4096, o);
  }
  function my(i, o, u) {
    i.lanes |= o;
    var h = i.alternate;
  ...
  function gy(i, o, u) {
    ...
    if (xt(i, o, h.children, u), h = Le.current, (h & 2) !== 0) h = h & 1 | 2, o.flags |= 128;
      ...
      if (i !== null && (i.flags & 128) !== 0) e: for (i = o.child; i !== null; ) {
        if (i.tag === 13) i.memoizedState !== null && my(i, u, o);
        else if (i.tag === 19) my(i, u, o);
    ...
    switch (o.tag) {
      ...
      case 13:
        if (h = o.memoizedState, h !== null)
          return h.dehydrated !== null ? (Me(Le, Le.current & 1), o.flags |= 128, null) : (u & o.child.childLanes) !== 0 ? py(i, o, u) : (Me(Le, Le.current & 1), i = Un(i, o, u), i !== null ? i.sibling : null);
        Me(Le, Le.current & 1);
        break;
      case 19:
        if (h = (u & o.childLanes) !== 0, (i.flags & 128) !== 0) {
          if (h) return gy(i, o, u);
          o.flags |= 128;
        }
  ...
  function ak(i, o, u) {
    ...
    switch (Oc(o), o.tag) {
      ...
      case 5:
        Kc(o);
        var y = $r(Js.current);
        if (u = o.type, i !== null && o.stateNode != null) vy(i, o, u, h, y), i.ref !== o.ref && (o.flags |= 512, o.flags |= 2097152);
        else {
          if (!h) {
          ...
          if (i = $r(An.current), za(o)) {
            ...
            k = y.nodeType === 9 ? y : y.ownerDocument, i === "http://www.w3.org/1999/xhtml" && (i = sm(u)), i === "http://www.w3.org/1999/xhtml" ? u === "script" ? (i = k.createElement("div"), i.innerHTML = "<script><\/script>", i = i.removeChild(i.firstChild)) : typeof h.is == "string" ? i = k.createElement(u, { is: h.is }) : (i = k.createElement(u), u === "select" && (k = i, h.multiple ? k.multiple = !0 : h.size && (k.size = h.size))) : i = k.createElementNS(i, u), i[Tn] = o, i[Ks] = h, yy(i, o, !1, !1), o.stateNode = i;
            e: {
              switch (k = qu(u, h), u) {
                case "dialog":
              ...
              for (x in R) if (R.hasOwnProperty(x)) {
                var N = R[x];
                x === "style" ? lm(i, N) : x === "dangerouslySetInnerHTML" ? (N = N ? N.__html : void 0, N != null && om(i, N)) : x === "children" ? typeof N == "string" ? (u !== "textarea" || N !== "") && bs(i, N) : typeof N == "number" && bs(i, "" + N) : x !== "suppressContentEditableWarning" && x !== "suppressHydrationWarning" && x !== "autoFocus" && (s.hasOwnProperty(x) ? N != null && x === "onScroll" && Ne("scroll", i) : N != null && C(i, x, N, k));
              }
              switch (u) {
                case "input":
                  la(i), tm(i, h, !1);
        ...
        return gt(o), null;
      case 6:
        if (i && o.stateNode != null) _y(i, o, i.memoizedProps, h);
        else {
      ...
      case 13:
        if (Ie(Le), h = o.memoizedState, i === null || i.memoizedState !== null && i.memoizedState.dehydrated !== null) {
          if (je && Bt !== null && (o.mode & 1) !== 0 && (o.flags & 128) === 0) wg(), Pi(), o.flags |= 98560, x = !1;
  ...
  function Sy(i) {
    var o = i.alternate;
    o !== null && (i.alternate = null, Sy(o)), i.child = null, i.deletions = null, i.sibling = null, i.tag === 5 && (o = i.stateNode, o !== null && (delete o[Tn], delete o[Ks], delete o[Ic], delete o[ZA], delete o[GA])), i.stateNode = null, i.return = null, i.dependencies = null, i.memoizedProps = null, i.memoizedState = null, i.pendingProps = null, i.stateNode = null, i.updateQueue = null;
  }
  function wy(i) {
  ...
  function Ty(i) {
    e: for (; ; ) {
      for (; i.sibling === null; ) {
        if (i.return === null || wy(i.return)) return null;
        i = i.return;
      }
  ...
  var ut = null, mn = !1;
  function cr(i, o, u) {
    for (u = u.child; u !== null; ) Ay(i, o, u), u = u.sibling;
  }
  function Ay(i, o, u) {
  ...
  function gn(i, o) {
    ...
    if (o.subtreeFlags & 12854) for (o = o.child; o !== null; ) by(o, i), o = o.sibling;
  }
  function by(i, o) {
    ...
    switch (i.tag) {
      ...
      case 5:
        ...
        if (h & 4 && (y = i.stateNode, y != null)) {
          ...
          if (i.updateQueue = null, N !== null) try {
            R === "input" && x.type === "radio" && x.name != null && em(y, x), qu(R, k);
            var B = qu(R, x);
            for (k = 0; k < N.length; k += 2) {
              var G = N[k], K = N[k + 1];
              G === "style" ? lm(y, K) : G === "dangerouslySetInnerHTML" ? om(y, K) : G === "children" ? bs(y, K) : C(y, G, K, B);
            }
            switch (R) {
              case "input":
                Wu(y, x);
      ...
      case 4:
        ...
        break;
      case 13:
        gn(o, i), bn(i), y = i.child, y.flags & 8192 && (x = y.memoizedState !== null, y.stateNode.isHidden = x, !x || y.alternate !== null && y.alternate.memoizedState !== null || (wd = Ge())), h & 4 && ky(i);
        break;
      case 22:
        if (G = u !== null && u.memoizedState !== null, i.mode & 1 ? (yt = (B = yt) || G, gn(o, i), yt = B) : gn(o, i), bn(i), h & 8192) {
          if (B = i.memoizedState !== null, (i.stateNode.isHidden = B) && !G && (i.mode & 1) !== 0) for (re = i, G = i.child; G !== null; ) {
            for (K = re = G; re !== null; ) {
              ...
              te !== null ? (te.return = Z, re = te) : Ey(K);
            }
            G = G.sibling;
          }
          e: for (G = null, K = i; ; ) {
            if (K.tag === 5) {
              if (G === null) {
                G = K;
                try {
                  y = K.stateNode, B ? (x = y.style, typeof x.setProperty == "function" ? x.setProperty("display", "none", "important") : x.display = "none") : (R = K.stateNode, N = K.memoizedProps.style, k = N != null && N.hasOwnProperty("display") ? N.display : null, R.style.display = am("display", k));
                } catch (le) {
                  We(i, i.return, le);
                }
              }
    ...
    if (o & 2) {
      try {
        ...
        switch (h.tag) {
          ...
          case 3:
          case 4:
            var k = h.stateNode.containerInfo, R = Ty(i);
            vd(i, R, k);
            break;
          default:
            throw Error(n(161));
    ...
    for (var h = (i.mode & 1) !== 0; re !== null; ) {
      ...
      if (y.tag === 22 && h) {
        ...
        if (!k) {
          ...
          R = el;
          var B = yt;
          if (el = k, (yt = N) && !B) for (re = y; re !== null; ) k = re, N = k.child, k.tag === 22 && k.memoizedState !== null ? My(y) : N !== null ? (N.return = k, re = N) : My(y);
          for (; x !== null; ) re = x, Cy(x), x = x.sibling;
          re = y, el = R, yt = B;
        }
        Py(i);
      } else (y.subtreeFlags & 8772) !== 0 && x !== null ? (x.return = y, re = x) : Py(i);
    }
  }
  function Py(i) {
    for (; re !== null; ) {
  ...
  var fk = Math.ceil, nl = M.ReactCurrentDispatcher, xd = M.ReactCurrentOwner, tn = M.ReactCurrentBatchConfig, Se = 0, st = null, qe = null, ct = 0, Ut = 0, ji = sr(0), tt = 0, oo = null, Br = 0, rl = 0, Sd = 0, ao = null, Et = null, wd = 0, Fi = 1 / 0, Hn = null, il = !1, Td = null, dr = null, sl = !1, fr = null, ol = 0, lo = 0, Ad = null, al = -1, ll = 0;
  function St() {
    return (Se & 6) !== 0 ? Ge() : al !== -1 ? al : al = Ge();
  }
  function hr(i) {
    return (i.mode & 1) === 0 ? 1 : (Se & 2) !== 0 && ct !== 0 ? ct & -ct : YA.transition !== null ? (ll === 0 && (ll = Tm()), ll) : (i = Ae, i !== 0 || (i = window.event, i = i === void 0 ? 16 : Nm(i.type)), i);
  }
  function yn(i, o, u, h) {
  ...
  function Mt(i, o) {
    ...
    if (h === 0) u !== null && xm(u), i.callbackNode = null, i.callbackPriority = 0;
    else if (o = h & -h, i.callbackPriority !== o) {
      if (u != null && xm(u), o === 1) i.tag === 0 ? KA(Ny.bind(null, i)) : yg(Ny.bind(null, i)), HA(function() {
        (Se & 6) === 0 && ar();
      }), u = null;
      else {
        switch (Am(h)) {
  ...
  function Ry(i, o) {
    ...
    if (o !== 0) {
      ...
      if (o === 6) pr(i, h);
        ...
        if (y = i.current.alternate, (h & 30) === 0 && !hk(y) && (o = ul(i, h), o === 2 && (x = ic(i), x !== 0 && (h = x, o = kd(i, x))), o === 1)) throw u = oo, Hr(i, 0), pr(i, h), Mt(i, Ge()), u;
    ...
    return Mt(i, Ge()), i.callbackNode === u ? Ry.bind(null, i) : null;
  }
  function kd(i, o) {
    var u = ao;
      ...
      try {
        ...
        e: {
          ...
          if (o = ct, R.flags |= 32768, N !== null && typeof N == "object" && typeof N.then == "function") {
            ...
            var te = iy(k);
            if (te !== null) {
              te.flags &= -257, sy(te, k, R, x, o), te.mode & 1 && ry(x, B, o), o = te, N = B;
            ...
            var Ke = iy(k);
            if (Ke !== null) {
              (Ke.flags & 65536) === 0 && (Ke.flags |= 256), sy(Ke, k, R, x, o), $c(Ii(N, R));
              break e;
            }
          }
  ...
  function jy(i) {
    var o = zy(i.alternate, i, Ut);
    i.memoizedProps = i.pendingProps, o === null ? Fy(i) : qe = o, xd.current = null;
  }
  function Fy(i) {
    var o = i;
    do {
  ...
  function gk(i, o, u, h) {
    ...
    if (qT(i, x), i === st && (qe = st = null, ct = 0), (u.subtreeFlags & 2064) === 0 && (u.flags & 2064) === 0 || sl || (sl = !0, $y(ha, function() {
      return Oi(), null;
      ...
      Ae = 1;
      var R = Se;
      Se |= 4, xd.current = null, ck(i, u), by(u, i), FA(Ec), xa = !!Pc, Ec = Pc = null, i.current = u, dk(u), VT(), Se = R, Ae = k, tn.transition = x;
    } else i.current = u;
  ...
  function Oi() {
    if (fr !== null) {
      var i = Am(ol), o = tn.transition, u = Ae;
      try {
  ...
  function Oy(i, o, u) {
    o = Ii(u, o), o = ty(i, o, 1), i = ur(i, o, 1), o = St(), i !== null && (Ns(i, 1, o), Mt(i, o));
  }
  function We(i, o, u) {
    if (i.tag === 3) Oy(i, i, u);
    else for (; o !== null; ) {
      if (o.tag === 3) {
        ...
        if (typeof o.type.getDerivedStateFromError == "function" || typeof h.componentDidCatch == "function" && (dr === null || !dr.has(h))) {
          i = Ii(u, i), i = ny(o, i, 1), o = ur(o, i, 1), i = St(), o !== null && (Ns(o, 1, i), Mt(o, i));
          break;
        }
      }
      o = o.return;
  ...
  zy = function(i, o, u) {
    ...
    else Pt = !1, je && (o.flags & 1048576) !== 0 && vg(o, La, o.index);
    switch (o.lanes = 0, o.tag) {
      ...
      case 1:
        return h = o.type, y = o.pendingProps, y = o.elementType === h ? y : pn(h, y), dy(i, o, h, y, u);
      case 3:
        e: {
          if (fy(o), i === null) throw Error(n(387));
          h = o.pendingProps, x = o.memoizedState, y = x.element, Cg(i, o), Ha(o, h, null, u);
          ...
          if (h = k.element, x.isDehydrated) if (x = { element: h, isDehydrated: !1, cache: k.cache, pendingSuspenseBoundaries: k.pendingSuspenseBoundaries, transitions: k.transitions }, o.updateQueue.baseState = x, o.memoizedState = x, o.flags & 256) {
            y = Ii(Error(n(423)), o), o = hy(i, o, h, u, y);
            break e;
          } else if (h !== y) {
            y = Ii(Error(n(424)), o), o = hy(i, o, h, u, y);
            break e;
          } else for (Bt = ir(o.stateNode.containerInfo.firstChild), Vt = o, je = !0, hn = null, u = kg(o, null, h, u), o.child = u; u; ) u.flags = u.flags & -3 | 4096, u = u.sibling;
          else {
            if (Pi(), h === y) {
              o = Un(i, o, u);
              break e;
        ...
        return o;
      case 5:
        return Mg(o), i === null && zc(o), h = o.type, y = o.pendingProps, x = i !== null ? i.memoizedProps : null, k = y.children, Mc(h, y) ? k = null : x !== null && Mc(h, x) && (o.flags |= 32), cy(i, o), xt(i, o, k, u), o.child;
      case 6:
      ...
      case 11:
        return h = o.type, y = o.pendingProps, y = o.elementType === h ? y : pn(h, y), oy(i, o, h, y, u);
      case 7:
      ...
      case 14:
        return h = o.type, y = pn(h, o.pendingProps), y = pn(h.type, y), ay(i, o, h, y, u);
      case 15:
        return ly(i, o, o.type, o.pendingProps, u);
      case 17:
        return h = o.type, y = o.pendingProps, y = o.elementType === h ? y : pn(h, y), Ja(i, o), o.tag = 1, Ct(h) ? (i = !0, ja(o)) : i = !1, Ri(o, u), Jg(o, h, y), od(o, h, y, u), cd(null, o, h, !0, i, u);
      case 19:
        return gy(i, o, u);
      case 22:
        return uy(i, o, u);
  ...
  function Id(i, o, u, h, y, x, k, R, N) {
    return i = new wk(i, o, u, R, N), o === 1 ? (o = 1, x === !0 && (o |= 8)) : o = 0, x = nn(3, null, null, o), i.current = x, x.stateNode = i, x.memoizedState = { element: h, isDehydrated: u, cache: null, transitions: null, pendingSuspenseBoundaries: null }, Zc(x), i;
  }
  function Tk(i, o, u) {
  ...
  function Vy(i) {
    ...
    if (i.tag === 1) {
      var u = i.type;
      if (Ct(u)) return mg(i, u, o);
    }
    return o;
  }
  function By(i, o, u, h, y, x, k, R, N) {
    return i = Id(u, h, !0, i, y, x, k, R, N), i.context = Vy(null), u = i.current, h = St(), y = hr(u), x = Bn(h, y), x.callback = o ?? null, ur(u, x, y), i.current.lanes = y, Ns(i, y, h), Mt(i, h), i;
  }
  function fl(i, o, u, h) {
    var y = o.current, x = St(), k = hr(y);
    return u = Vy(u), o.context === null ? o.context = u : o.pendingContext = u, o = Bn(x, k), o.payload = { element: i }, h = h === void 0 ? null : h, h !== null && (o.callback = h), i = ur(y, o, k), i !== null && (yn(i, y, k, x), Ua(i, y, k)), k;
  }
  function hl(i) {
  ...
  function Dd(i, o) {
    Uy(i, o), (i = i.alternate) && Uy(i, o);
  }
  function Ak() {
    return null;
  }
  var Hy = typeof reportError == "function" ? reportError : function(i) {
    console.error(i);
  };
  function jd(i) {
  ...
  function kk(i, o, u, h, y) {
    ...
    var N = Id(i, 0, !1, null, null, !1, !1, "", Wy);
  ...
  return Rt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = bk, Rt.createPortal = function(i, o) {
    ...
    return i = ym(o), i = i === null ? null : i.stateNode, i;
    ...
    var h = u != null && u.hydratedSources || null, y = !1, x = "", k = Hy;
    if (u != null && (u.unstable_strictMode === !0 && (y = !0), u.identifierPrefix !== void 0 && (x = u.identifierPrefix), u.onRecoverableError !== void 0 && (k = u.onRecoverableError)), o = By(o, null, i, 1, u ?? null, y, !1, x, k), i[On] = o.current, Zs(i), h) for (i = 0; i < h.length; i++) u = h[i], y = u._getVersion, y = y(u._source), o.mutableSourceEagerHydrationData == null ? o.mutableSourceEagerHydrationData = [u, y] : o.mutableSourceEagerHydrationData.push(
      u,
      y
    );
    return new pl(o);
...
function D_() {
  ...
  return t(), Ld.exports = Lk(), Ld.exports;
}
var nv;
function zk() {
  if (nv) return vl;
...
var iv;
function Bk() {
  return iv || (iv = 1, Vd.exports = Vk()), Vd.exports;
}
var _ = Bk();
const sv = (t) => Symbol.iterator in t, ov = (t) => (
...
function Hk(t, e) {
  return Object.is(t, e) ? !0 : typeof t != "object" || t === null || typeof e != "object" || e === null || Object.getPrototypeOf(t) !== Object.getPrototypeOf(e) ? !1 : sv(t) && sv(e) ? ov(t) && ov(e) ? av(t, e) : Uk(t, e) : av(
...
const Lh = E.createContext({});
function zh(t) {
  const e = E.useRef(null);
  return e.current === null && (e.current = t()), e.current;
}
const Zk = typeof window < "u", j_ = Zk ? E.useLayoutEffect : E.useEffect, Cu = /* @__PURE__ */ E.createContext(null);
function $h(t, e) {
...
var P_;
typeof process < "u" && ((P_ = process.env) == null ? void 0 : P_.NODE_ENV) !== "production" && (Ko = (t, e, n) => {
  !t && typeof console < "u" && console.warn(lv(e, n));
}, ui = (t, e, n) => {
  if (!t)
    throw new Error(lv(e, n));
});
const Cr = {}, F_ = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t), O_ = (t) => typeof t == "object" && t !== null, L_ = (t) => /^0[^.\s]+$/u.test(t);
// @__NO_SIDE_EFFECTS__
function z_(t) {
  let e;
...
const It = /* @__NO_SIDE_EFFECTS__ */ (t) => t * 1e3, on = /* @__NO_SIDE_EFFECTS__ */ (t) => t / 1e3, $_ = /* @__NO_SIDE_EFFECTS__ */ (t, e) => e ? t * (1e3 / e) : 0, V_ = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t, Gk = 1e-7, Kk = 12;
function Yk(t, e, n, r, s) {
  let a, l, c = 0;
  do
    l = e + (n - e) / 2, a = V_(l, r, s) - t, a > 0 ? n = l : e = l;
...
function qo(t, e, n, r) {
  ...
  return (a) => a === 0 || a === 1 ? a : V_(s(a), e, r);
}
const B_ = /* @__NO_SIDE_EFFECTS__ */ (t) => (e) => e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2, U_ = /* @__NO_SIDE_EFFECTS__ */ (t) => (e) => 1 - t(1 - e), H_ = /* @__PURE__ */ qo(0.33, 1.53, 0.69, 0.99), Bh = /* @__PURE__ */ U_(H_), W_ = /* @__PURE__ */ B_(Bh), Z_ = (t) => t >= 1 ? 1 : (t *= 2) < 1 ? 0.5 * Bh(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))), Uh = (t) => 1 - Math.sin(Math.acos(t)), G_ = /* @__PURE__ */ U_(Uh), K_ = /* @__PURE__ */ B_(Uh), qk = /* @__PURE__ */ qo(0.42, 0, 1, 1), Qk = /* @__PURE__ */ qo(0, 0, 0.58, 1), Y_ = /* @__PURE__ */ qo(0.42, 0, 0.58, 1), Xk = /* @__NO_SIDE_EFFECTS__ */ (t) => Array.isArray(t) && typeof t[0] != "number", q_ = /* @__NO_SIDE_EFFECTS__ */ (t) => Array.isArray(t) && typeof t[0] == "number", uv = {
  linear: un,
  easeIn: qk,
  easeInOut: Y_,
  easeOut: Qk,
...
function Q_(t, e) {
  ...
  const s = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, a = () => n = !0, l = _l.reduce((C, M) => (C[M] = eb(a), C), {}), { setup: c, read: f, resolveKeyframes: m, preUpdate: g, update: d, preRender: p, render: v, postRender: w } = l, S = () => {
    const C = Cr.useManualTiming, M = C ? s.timestamp : performance.now();
  ...
  return { schedule: _l.reduce((C, M) => {
    const P = l[M];
    return C[M] = ($, I = !1, O = !1) => (n || T(), P.schedule($, I, O)), C;
  }, {}), cancel: (C) => {
    for (let M = 0; M < _l.length; M++)
      l[_l[M]].cancel(C);
  }, state: s, steps: l };
}
const { schedule: Ee, cancel: Pr, state: dt, steps: Bd } = /* @__PURE__ */ Q_(typeof requestAnimationFrame < "u" ? requestAnimationFrame : un, !0);
let Dl;
function nb() {
  Dl = void 0;
}
const Tt = {
  ...
  set: (t) => {
    Dl = t, queueMicrotask(nb);
  }
}, X_ = (t) => (e) => typeof e == "string" && e.startsWith(t), J_ = /* @__PURE__ */ X_("--"), rb = /* @__PURE__ */ X_("var(--"), Hh = (t) => rb(t) ? ib.test(t.split("/*")[0].trim()) : !1, ib = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
function dv(t) {
...
const ob = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, Zh = (t, e) => (n) => !!(typeof n == "string" && ob.test(n) && n.startsWith(t) || e && !sb(n) && Object.prototype.hasOwnProperty.call(n, e)), ex = (t, e, n) => (r) => {
  if (typeof r != "string")
    return r;
  ...
  parse: /* @__PURE__ */ ex("red", "green", "blue"),
...
const Cf = {
  ...
  parse: parseFloat,
  transform: (e) => `${e}${t}`
}), Wn = /* @__PURE__ */ Qo("deg"), Dn = /* @__PURE__ */ Qo("%"), oe = /* @__PURE__ */ Qo("px"), ub = /* @__PURE__ */ Qo("vh"), cb = /* @__PURE__ */ Qo("vw"), fv = {
  ...Dn,
  parse: (t) => Dn.parse(t) / 100,
  transform: (t) => Dn.transform(t * 100)
}, Ki = {
  test: /* @__PURE__ */ Zh("hsl", "hue"),
  parse: /* @__PURE__ */ ex("hue", "saturation", "lightness"),
...
function fb(t) {
  var e, n;
  return isNaN(t) && typeof t == "string" && (((e = t.match(Wh)) == null ? void 0 : e.length) || 0) + (((n = t.match(db)) == null ? void 0 : n.length) || 0) > 0;
}
const tx = "number", nx = "color", hb = "var", pb = "var(", hv = "${}", mb = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function as(t) {
  ...
  let a = 0;
  const c = e.replace(mb, (f) => (Qe.test(f) ? (r.color.push(a), s.push(nx), n.push(Qe.parse(f))) : f.startsWith(pb) ? (r.var.push(a), s.push(hb), n.push(f)) : (r.number.push(a), s.push(tx), n.push(parseFloat(f))), ++a, hv)).split(hv);
  return { values: n, split: c, indexes: r, types: s };
}
function gb(t) {
  return as(t).values;
}
function rx({ split: t, types: e }) {
  const n = t.length;
  return (r) => {
    let s = "";
    for (let a = 0; a < n; a++)
      if (s += t[a], r[a] !== void 0) {
        const l = e[a];
        l === tx ? s += So(r[a]) : l === nx ? s += Qe.transform(r[a]) : s += r[a];
      }
    return s;
  };
}
...
function xb(t) {
  const e = as(t);
  return rx(e)(e.values.map((r, s) => _b(r, e.split[s])));
}
const xn = {
  test: fb,
  parse: gb,
...
}, wb = [Cf, ei, Ki], Tb = (t) => wb.find((e) => e.test(t));
function pv(t) {
  const e = Tb(t);
...
function Gh(t) {
  return typeof t == "number" ? kb : typeof t == "string" ? Hh(t) ? nu : Qe.test(t) ? mv : Pb : Array.isArray(t) ? ix : typeof t == "object" ? Qe.test(t) ? mv : bb : nu;
}
function ix(t, e) {
...
const Pb = (t, e) => {
  ...
  return r.indexes.var.length === s.indexes.var.length && r.indexes.color.length === s.indexes.color.length && r.indexes.number.length >= s.indexes.number.length ? Pf.has(t) && !s.values.length || Pf.has(e) && !r.values.length ? Ab(t, e) : Yo(ix(Cb(r, s), s.values), n) : (Ko(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), nu(t, e));
};
function sx(t, e, n) {
...
function iu(t = $e.visualDuration, e = $e.bounce) {
  ...
  let C, M, P, $, I, O;
  if (S < 1)
    P = Ef(A, S), $ = (w + S * A * T) / P, C = (U) => {
      const q = Math.exp(-S * A * U);
      return l - q * ($ * Math.sin(P * U) + T * Math.cos(P * U));
    }, I = S * A * $ + T * P, O = S * A * T - $ * P, M = (U) => Math.exp(-S * A * U) * (I * Math.sin(P * U) + O * Math.cos(P * U));
  else if (S === 1) {
  ...
  const L = {
    ...
    next: (U) => {
      if (!v && S < 1) {
        const ee = Math.exp(-S * A * U), ne = Math.sin(P * U), ie = Math.cos(P * U), ge = l - ee * ($ * ne + T * ie), ce = /* @__PURE__ */ It(ee * (I * ne + O * ie));
    ...
    toString: () => {
      const U = Math.min(Kh(L), ru), q = ox((ee) => L.next(U * ee).value, U, 30);
      return U + "ms " + q;
    },
    toTransition: () => {
    }
...
function Mf({ keyframes: t, velocity: e = 0, power: n = 0.8, timeConstant: r = 325, bounceDamping: s = 10, bounceStiffness: a = 500, modifyTarget: l, min: c, max: f, restDelta: m = 0.5, restSpeed: g }) {
  ...
  return I(0), {
    ...
    next: (O) => {
      let L = !1;
      return !$ && P === void 0 && (L = !0, M(O), I(O)), P !== void 0 && O >= P ? $.next(O - P) : (!L && M(O), p);
    }
  };
}
function Lb(t, e, n) {
  const r = [], s = n || Cr.mix || sx, a = t.length - 1;
  for (let l = 0; l < a; l++) {
    let c = s(t[l], t[l + 1]);
    if (e) {
...
function Ub(t, e) {
  return t.map(() => e || Y_).splice(0, t.length - 1);
}
function wo({ duration: t = 300, keyframes: e, times: n, ease: r = "easeInOut" }) {
  const s = /* @__PURE__ */ Xk(r) ? r.map(cv) : cv(r), a = {
    done: !1,
    value: e[0]
  }, l = Bb(
...
class su extends Yh {
  ...
  initAnimation() {
    ...
    let { keyframes: c } = e;
    const f = n || wo;
    f !== wo && typeof c[0] != "number" && (this.mixKeyframes = Yo(Zb, sx(c[0], c[1])), c = [0, 100]);
  ...
  tick(e, n = !1) {
    ...
    return I && w !== Mf && (P.value = Pu(g, this.options, T, this.speed)), S && S(P.value), I && this.finish(), P;
  }
  /**
  ...
  getGeneratorVelocity() {
    ...
    return ax((r) => this.generator.next(r).value, e, n);
  }
  get speed() {
...
}, Nf = (t) => (t = t % 360, t < 0 && (t += 360), t), yv = Rf, vv = (t) => Math.sqrt(t[0] * t[0] + t[1] * t[1]), _v = (t) => Math.sqrt(t[4] * t[4] + t[5] * t[5]), Yb = {
  x: 12,
  y: 13,
  z: 14,
  translateX: 12,
...
const ws = [
  ...
  "skewX",
  "skewY"
], Ts = /* @__PURE__ */ new Set([...ws, "pathRotation"]), xv = (t) => t === Ss || t === oe, Xb = /* @__PURE__ */ new Set(["x", "y", "z"]), Jb = ws.filter((t) => !Xb.has(t));
function eC(t) {
  const e = [];
  return Jb.forEach((n) => {
...
class qh {
  ...
  scheduleResolve() {
    this.state = "scheduled", this.isAsync ? (ri.add(this), jf || (jf = !0, Ee.read(cx), Ee.resolveKeyframes(ux))) : (this.readKeyframes(), this.complete());
  }
  readKeyframes() {
...
const rC = {};
function fx(t, e) {
  const n = /* @__PURE__ */ z_(t);
  return () => rC[e] ?? n();
}
const iC = /* @__PURE__ */ fx(() => window.ScrollTimeline !== void 0, "scrollTimeline"), hx = /* @__PURE__ */ fx(() => {
  try {
  ...
  return !0;
}, "linearEasing"), mo = ([t, e, n, r]) => `cubic-bezier(${t}, ${e}, ${n}, ${r})`, Sv = {
  linear: "linear",
  ease: "ease",
  easeIn: "ease-in",
  easeOut: "ease-out",
...
function px(t, e) {
  if (t)
    return typeof t == "function" ? hx() ? ox(t, e) : "ease-out" : /* @__PURE__ */ q_(t) ? mo(t) : Array.isArray(t) ? t.map((n) => px(n, e) || Sv.easeOut) : Sv[t];
}
...
function oC({ type: t, ...e }) {
  return mx(t) && hx() ? t.applyToOptions(e) : (e.duration ?? (e.duration = 300), e.ease ?? (e.ease = "easeOut"), e);
}
class gx extends Yh {
  constructor(e) {
    ...
    this.animation = sC(n, r, s, m, a), m.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
      if (this.finishedTime = this.time, !a) {
        ...
        this.updateMotionValue && this.updateMotionValue(g), dx(n, r, g), this.animation.cancel();
      }
...
function lC(t) {
  typeof t.ease == "string" && aC(t.ease) && (t.ease = yx[t.ease]);
}
const Gd = 10;
class uC extends gx {
  constructor(e) {
    lC(e), lx(e), super(e), e.startTime !== void 0 && e.autoplay !== !1 && (this.startTime = e.startTime), this.options = e;
  }
  /**
   * WAAPI doesn't natively have any interruption capabilities.
   *
  ...
  updateMotionValue(e) {
    ...
    a && d && dx(a, d, g), n.setWithVelocity(c.sample(Math.max(0, f - m)).value, g, m), c.stop();
  }
}
const wv = (t, e) => e === "zIndex" ? !1 : !!(typeof t == "number" || Array.isArray(t) || typeof t == "string" && // It's animatable if we have a string
...
function dC(t, e, n, r) {
  ...
  if (e === "display" || e === "visibility")
    return !0;
  const a = t[t.length - 1], l = wv(s, e), c = wv(a, e);
  return Ko(l === c, `You are trying to animate ${e} from "${s}" to "${a}". "${l ? a : s}" is not an animatable value.`, "value-not-animatable"), !l || !c ? !1 : cC(t) || (n === "spring" || mx(n)) && r;
}
function Lf(t) {
...
const pC = /* @__PURE__ */ new Set([
  ...
  "borderBottomColor",
  "borderLeftColor"
]), mC = /* @__PURE__ */ z_(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function gC(t) {
  var d;
   ...
   */
  (vx.has(n) || pC.has(n) && hC(c)) && (n !== "transform" || !g) && /**
...
class vC extends Yh {
  ...
  onKeyframesResolved(e, n, r, s) {
    ...
    let d = !0;
    dC(e, a, l, c) || (d = !1, (Cr.instantAnimations || !f) && (g == null || g(Pu(e, r, n))), e[0] = e[e.length - 1], Lf(r), r.repeat = 0);
    const v = {
...
const Tv = 30, _C = (t) => !isNaN(parseFloat(t));
class xC {
  /**
  ...
  getVelocity() {
    const e = Tt.now();
    if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > Tv)
      return 0;
    const n = Math.min(this.updatedAt - this.prevUpdatedAt, Tv);
    return /* @__PURE__ */ $_(parseFloat(this.current) - parseFloat(this.prevFrameValue), n);
  }
  /**
...
const Xh = (t, e, n, r = {}, s, a) => (l) => {
  ...
  return c.isSync ? new su(g) : new vC(g);
}, PC = (
...
const MC = 4;
function Sx(t, e, n = 1) {
  ui(n <= MC, `Max CSS variable fallback depth detected in property "${t}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
  const [r, s] = EC(t);
  if (!r)
    return;
  ...
  if (a) {
    const l = a.trim();
    return F_(l) ? parseFloat(l) : l;
  }
  return Hh(s) ? Sx(s, e, n + 1) : s;
}
function Av(t) {
  const e = [{}, {}];
...
const jC = "framerAppearId", Tx = "data-" + ep(jC);
function Ax(t) {
  return t.props[Tx];
}
...
function kx(t, e, { delay: n = 0, transitionOverride: r, type: s } = {}) {
  ...
  for (const w in c) {
    ...
    S.start(Xh(w, S, T, M && wx.has(w) ? { type: !1 } : A, t, C));
    const P = S.animation;
    P && d.push(P);
  }
  if (l) {
...
function Vf(t, e, n = {}) {
  ...
  const a = r ? () => Promise.all(kx(t, r, n)) : () => Promise.resolve(), l = t.variantChildren && t.variantChildren.size ? (m = 0) => {
...
function OC(t, e, n = 0, r = 0, s = 0, a = 1, l) {
  ...
  for (const f of t.variantChildren)
    f.notify("AnimationStart", e), c.push(Vf(f, e, {
      ...l,
      delay: n + (typeof r == "function" ? 0 : r) + _x(t.variantChildren, f, r, s, a)
...
const zC = {
  test: (t) => t === "auto",
  parse: (t) => t
}, bx = (t) => (e) => e.test(t), Cx = [Ss, oe, Dn, Wn, cb, ub, zC], kv = (t) => Cx.find(bx(t));
function $C(t) {
  return typeof t == "number" ? t === 0 : t !== null ? t === "none" || t === "0" || L_(t) : !0;
}
...
const UC = /\b([a-z-]*)\(.*?\)/gu, Bf = {
  ...
  mask: Uf,
  WebkitMask: Uf
}, Px = (t) => WC[t], ZC = /* @__PURE__ */ new Set([Bf, Uf]);
function Ex(t, e) {
  let n = Px(t);
  ...
  readKeyframes() {
    ...
    for (let g = 0; g < e.length; g++) {
      ...
      if (typeof d == "string" && (d = d.trim(), Hh(d))) {
        const p = Sx(d, n.current);
        p !== void 0 && (e[g] = p), g === e.length - 1 && (this.finalKeyframe = d);
      }
    }
    if (this.resolveNoneKeyframes(), !wx.has(r) || e.length !== 2)
      return;
    const [s, a] = e, l = kv(s), c = kv(a), f = dv(s), m = dv(a);
    if (f !== m && xr[r]) {
...
function jl(t) {
  return O_(t) && "offsetHeight" in t && !("ownerSVGElement" in t);
}
const { schedule: tp } = /* @__PURE__ */ Q_(queueMicrotask, !1), _n = {
  x: !1,
  y: !1
};
function Rx() {
...
const Ix = (t, e) => e ? t === e ? !0 : Ix(t, e.parentElement) : !1, np = (t) => t.pointerType === "mouse" ? typeof t.button != "number" || t.button <= 0 : t.isPrimary !== !1, JC = /* @__PURE__ */ new Set([
  "BUTTON",
  "INPUT",
  "SELECT",
  "TEXTAREA",
...
const Ev = /* @__PURE__ */ new WeakSet();
function iP(t, e, n = {}) {
  const [r, s, a] = Nx(t, n), l = (c) => {
    const f = c.currentTarget;
    if (!Pv(c) || Ev.has(c))
      return;
    Fl.add(f), n.stopPropagation && Ev.add(c);
    const m = e(f, c), g = (v, w) => {
      window.removeEventListener("pointerup", d), window.removeEventListener("pointercancel", p), Fl.has(f) && Fl.delete(f), Pv(v) && typeof m == "function" && m(v, { success: w });
    }, d = (v) => {
      g(v, f === window || f === document || n.useGlobalTarget || Ix(f, v.target));
    }, p = (v) => {
      g(v, !1);
    };
  ...
  return r.forEach((c) => {
    (n.useGlobalTarget ? window : c).addEventListener("pointerdown", l, s), jl(c) && (c.addEventListener("focus", (m) => rP(m, s)), !eP(c) && !c.hasAttribute("tabindex") && (c.tabIndex = 0));
  }), a;
}
function rp(t) {
  return O_(t) && "ownerSVGElement" in t;
}
const Ol = /* @__PURE__ */ new WeakMap();
let vr;
const Dx = (t, e, n) => (r, s) => s && s[0] ? s[0][t + "Size"] : rp(r) && "getBBox" in r ? r.getBBox()[e] : r[n], sP = /* @__PURE__ */ Dx("inline", "width", "offsetWidth"), oP = /* @__PURE__ */ Dx("block", "height", "offsetHeight");
...
const pP = [...Cx, Qe, xn], mP = (t) => pP.find(bx(t)), Rv = () => ({
  translate: 0,
  scale: 1,
  origin: 0,
  originPoint: 0
...
const Wf = { current: null }, Fx = { current: !1 }, vP = typeof window < "u";
function _P() {
  if (Fx.current = !0, !!vP)
...
class SP {
  ...
  constructor({ parent: e, props: n, presenceContext: r, reducedMotionConfig: s, skipAnimations: a, blockInitialAnimation: l, visualState: c }, f = {}) {
    ...
    this.latestValues = m, this.baseTarget = { ...m }, this.initialValues = n.initial ? { ...m } : {}, this.renderState = g, this.parent = e, this.props = n, this.presenceContext = r, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = s, this.skipAnimationsConfig = a, this.options = f, this.blockInitialAnimation = !!l, this.isControllingVariants = Mu(n), this.isVariantNode = jx(n), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
  ...
  bindToMotionValue(e, n) {
    if (this.valueSubscriptions.has(e) && this.valueSubscriptions.get(e)(), n.accelerate && vx.has(e) && this.current instanceof HTMLElement) {
      const { factory: l, keyframes: c, times: f, ease: m, duration: g } = n.accelerate, d = new gx({
  ...
  readValue(e, n) {
    ...
    return r != null && (typeof r == "string" && (F_(r) || L_(r)) ? r = parseFloat(r) : !mP(r) && xn.test(n) && (r = Ex(e, n)), this.setBaseTarget(e, ft(r) ? r.get() : r)), ft(r) ? r.get() : r;
  }
  /**
...
function zx({ top: t, left: e, right: n, bottom: r }) {
  return {
    x: { min: e, max: n },
    y: { min: t, max: r }
  };
...
function qr(t) {
  return Zf(t) || $x(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY;
}
function $x(t) {
  return Dv(t.x) || Dv(t.y);
}
function Dv(t) {
  return t && t !== "0%";
}
...
function AP(t, e, n, r = !1) {
  ...
  for (let f = 0; f < s; f++) {
    ...
    m && m.props.style && m.props.style.display === "contents" || (r && a.options.layoutScroll && a.scroll && a !== a.root && (Mn(t.x, -a.scroll.offset.x), Mn(t.y, -a.scroll.offset.y)), l && (e.x *= l.x.scale, e.y *= l.y.scale, Vx(t, l)), r && qr(a.latestValues) && zl(t, a.latestValues, (c = a.layout) == null ? void 0 : c.layoutBox));
  }
  e.x < Ov && e.x > Fv && (e.x = 1), e.y < Ov && e.y > Fv && (e.y = 1);
}
function Mn(t, e) {
  t.min += e, t.max += e;
}
function Lv(t, e, n, r, s = 0.5) {
...
function zl(t, e, n) {
  const r = n ?? t;
  Lv(t.x, zv(e.x, r.x), e.scaleX, e.scale, e.originX), Lv(t.y, zv(e.y, r.y), e.scaleY, e.scale, e.originY);
}
function Bx(t, e) {
  return zx(TP(t.getBoundingClientRect(), e));
}
function kP(t, e, n) {
  const r = Bx(t, n), { scroll: s } = e;
...
function Ux(t, { style: e, vars: n }, r, s) {
  const a = t.style;
  let l;
  for (l in e)
    a[l] = e[l];
  ...
  correct: (t, e) => {
    ...
    if (typeof t == "string")
      if (oe.test(t))
        ...
        return t;
    const n = $v(t, e.target.x), r = $v(t, e.target.y);
    return `${n}% ${r}%`;
  }
}, EP = {
...
function Hx(t, { layout: e, layoutId: n }) {
...
function ap(t, e, n) {
  ...
  if (!r)
    return a;
  for (const c in r)
    (ft(r[c]) || s && ft(s[c]) || Hx(c, t) || ((l = n == null ? void 0 : n.getValue(c)) == null ? void 0 : l.liveStyle) !== void 0) && (a[c] = r[c]);
  return a;
}
function MP(t) {
...
class RP extends Lx {
  constructor() {
    super(...arguments), this.type = "html", this.renderInstance = Ux;
  }
  readValueFromInstance(e, n) {
    var r;
    if (Ts.has(n))
      return (r = this.projection) != null && r.isProjecting ? If(n) : qb(e, n);
    {
      const s = MP(e), a = (J_(n) ? s.getPropertyValue(n) : s[n]) || 0;
...
const Zx = /* @__PURE__ */ new Set([
  ...
  "textLength",
  "lengthAdjust"
]), Gx = (t) => typeof t == "string" && t.toLowerCase() === "svg";
function FP(t, e, n, r) {
  Ux(t, e, void 0, r);
  for (const s in e.attrs)
    t.setAttribute(Zx.has(s) ? s : ep(s), e.attrs[s]);
}
function Kx(t, e, n) {
  const r = ap(t, e, n);
  for (const s in t)
...
class OP extends Lx {
  ...
  readValueFromInstance(e, n) {
    ...
    return n = Zx.has(n) ? n : ep(n), e.getAttribute(n);
  }
  scrapeMotionValuesFromProps(e, n, r) {
    return Kx(e, n, r);
  }
  build(e, n, r) {
    Wx(e, n, this.isSVGTag, r.transformTemplate, r.style);
  }
  renderInstance(e, n, r, s) {
    FP(e, n, r, s);
  }
  mount(e) {
    this.isSVGTag = Gx(e.tagName), super.mount(e);
  }
}
const LP = sp.length;
function Yx(t) {
...
function BP(t) {
  ...
  function c(m) {
    const { props: g } = t, d = Yx(t.parent) || {}, p = [], v = /* @__PURE__ */ new Set();
    let w = {}, S = 1 / 0;
    for (let A = 0; A < $P; A++) {
      const b = zP[A], C = n[b], M = g[b] !== void 0 ? g[b] : d[b], P = jo(M), $ = b === m ? C.isActive : null;
      $ === !1 && (S = A);
      let I = M === d[b] && M !== g[b] && P;
      ...
      b === m && C.isActive && !I && P || // If we removed a higher-priority variant (i is in reverse order)
      A > S && P, U = !1;
      ...
      for (const W in ie) {
        ...
        if (w.hasOwnProperty(W))
          continue;
        let F = !1;
        zf(J) && zf(Q) ? F = !qx(J, Q) || O : F = J !== Q, F ? J != null ? ge(W) : v.add(W) : J !== void 0 && v.has(W) ? ge(W) : C.protectedKeys[W] = !0;
      }
      ...
      L && (!ce || U) && p.push(...q.map((W) => {
        ...
        if (typeof W == "string" && (r || s) && !ce && t.manuallyAnimateOnMount && t.parent) {
          ...
          if (Q.enteringChildren && F) {
            ...
            J.delay = _x(Q.enteringChildren, t, D);
          }
        }
        return {
          animation: W,
...
const Qx = 1e-4, HP = 1 - Qx, WP = 1 + Qx, Xx = 0.01, ZP = 0 - Xx, GP = 0 + Xx;
function At(t) {
  return t.max - t.min;
}
function KP(t, e, n) {
...
function To(t, e, n, r) {
  Uv(t.x, e.x, n.x, r ? r.originX : void 0), Uv(t.y, e.y, n.y, r ? r.originY : void 0);
}
function Hv(t, e, n, r = 0) {
  const s = r ? Pe(n.min, n.max, r) : n.min;
  t.min = s + e.min, t.max = t.min + At(e);
}
function YP(t, e, n, r) {
  Hv(t.x, e.x, n.x, r == null ? void 0 : r.x), Hv(t.y, e.y, n.y, r == null ? void 0 : r.y);
}
function Wv(t, e, n, r = 0) {
  const s = r ? Pe(n.min, n.max, r) : n.min;
  t.min = e.min - s, t.max = t.min + At(e);
}
function uu(t, e, n, r) {
  Wv(t.x, e.x, n.x, r == null ? void 0 : r.x), Wv(t.y, e.y, n.y, r == null ? void 0 : r.y);
}
...
function qP(t, e = 0, n = 1, r = 0.5, s, a = t, l = t) {
  ...
  t === a && (c -= e), t.min = Zv(t.min, e, n, c, s), t.max = Zv(t.max, e, n, c, s);
}
function Gv(t, e, [n, r, s], a, l) {
  qP(t, e[n], e[r], e[s], e.scale, a, l);
}
const QP = ["x", "scaleX", "originX"], XP = ["y", "scaleY", "originY"];
function Kv(t, e, n, r) {
  Gv(t.x, e, QP, n ? n.x : void 0, r ? r.x : void 0), Gv(t.y, e, XP, n ? n.y : void 0, r ? r.y : void 0);
}
function Yv(t) {
...
const tS = [
  ...
  "borderBottomLeftRadius",
  "borderBottomRightRadius"
], tE = tS.length, e0 = (t) => typeof t == "string" ? parseFloat(t) : t, t0 = (t) => typeof t == "number" || oe.test(t);
function nE(t, e, n, r, s, a) {
  ...
  for (let l = 0; l < tE; l++) {
    const c = tS[l];
    let f = n0(e, c), m = n0(n, c);
    if (f === void 0 && m === void 0)
      continue;
    f || (f = 0), m || (m = 0), f === 0 || m === 0 || t0(f) === t0(m) ? (t[c] = Math.max(Pe(e0(f), e0(m), r), 0), (Dn.test(m) || Dn.test(f)) && (t[c] += "%")) : t[c] = m;
  }
...
const rE = /* @__PURE__ */ nS(0, 0.5, G_), iE = /* @__PURE__ */ nS(0.5, 0.95, un);
function nS(t, e, n) {
...
function iS({ attachResizeListener: t, defaultParent: e, measureScroll: n, checkIsScrollRoot: r, resetTransform: s }) {
  return class {
    ...
    mount(l) {
      if (this.instance)
        return;
      this.isSVG = rp(l) && !hP(l), this.instance = l;
      ...
      if (m && !m.current && m.mount(l), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (f || c) && (this.isLayoutDirty = !0), t) {
        ...
        Ee.read(() => {
          ...
          v !== d && (d = v, this.root.updateBlockedByResize = !0, g && g(), g = lE(p, 250), Vl.hasAnimatedSinceResize && (Vl.hasAnimatedSinceResize = !1, this.nodes.forEach(s0)));
        });
      }
      c && this.root.registerSharedNode(c, this), this.options.animate !== !1 && m && (c || f) && this.addEventListener("didUpdate", ({ delta: g, hasLayoutChanged: d, hasRelativeLayoutChanged: p, layout: v }) => {
        ...
        const w = this.options.transition || m.getDefaultTransition() || bE, { onLayoutAnimationStart: S, onLayoutAnimationComplete: T } = m.getProps(), A = !this.targetLayout || !eS(this.targetLayout, v), b = !d && p;
        if (this.options.layoutRoot || this.resumeFrom || b || d && (A || !this.currentAnimation)) {
          ...
          d || s0(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
        this.targetLayout = v;
      });
    }
    unmount() {
    ...
    update() {
      if (this.updateScheduled = !1, this.isUpdateBlocked()) {
        ...
        this.unblockUpdate(), this.updateBlockedByResize = !1, this.clearAllSnapshots(), f && this.nodes.forEach(yE), this.nodes.forEach(r0);
        return;
      }
      ...
      this.animationCommitId = this.animationId, this.isUpdating ? (this.isUpdating = !1, this.nodes.forEach(vE), this.nodes.forEach(_E), this.nodes.forEach(fE), this.nodes.forEach(hE)) : this.nodes.forEach(i0), this.clearAllSnapshots();
      const c = Tt.now();
    ...
    resetTransform() {
      if (!s)
        return;
      const l = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout, c = this.projectionDelta && !Jx(this.projectionDelta), f = this.getTransformTemplate(), m = f ? f(this.latestValues, "") : void 0, g = m !== this.prevTransformTemplateValue;
    ...
    removeTransform(l) {
      ...
      for (let m = 0; m < this.path.length; m++) {
        ...
        if (!qr(g.latestValues))
          continue;
        let d;
        g.instance && (Zf(g.latestValues) && g.updateSnapshot(), d = nt(), vn(d, g.measurePageBox())), Kv(c, g.latestValues, (f = g.snapshot) == null ? void 0 : f.layoutBox, d);
      }
      return qr(this.latestValues) && Kv(c, this.latestValues), c;
    }
    setTargetDelta(l) {
    ...
    resolveTargetDelta(l = !1) {
      ...
      p && this.linkedParentVersion !== p.layoutVersion && !p.options.layoutRoot && this.removeRelativeTarget(), !this.targetDelta && !this.relativeTarget && (this.options.layoutAnchor !== !1 && p && p.layout ? this.createRelativeTarget(p, this.layout.layoutBox, p.layout.layoutBox) : this.removeRelativeTarget()), !(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = nt(), this.targetWithTransforms = nt()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), YP(this.target, this.relativeTarget, this.relativeParent.target, this.options.layoutAnchor || void 0)) : this.targetDelta ? (this.resumingFrom ? this.applyTransform(this.layout.layoutBox, !1, this.target) : vn(this.target, this.layout.layoutBox), Vx(this.target, this.targetDelta)) : vn(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget && (this.attemptToResolveRelativeTarget = !1, this.options.layoutAnchor !== !1 && p && !!p.resumingFrom == !!this.resumingFrom && !p.options.layoutScroll && p.target && this.animationProgress !== 1 ? this.createRelativeTarget(p, this.target, p.target) : this.relativeParent = this.relativeTarget = void 0));
    }
    getClosestProjectingParent() {
      if (!(!this.parent || Zf(this.parent.latestValues) || $x(this.parent.latestValues)))
    ...
    calcProjection() {
      ...
      !this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (Bv(this.prevProjectionDelta.x, this.projectionDelta.x), Bv(this.prevProjectionDelta.y, this.projectionDelta.y)), To(this.projectionDelta, this.layoutCorrected, v, this.latestValues), (this.treeScale.x !== d || this.treeScale.y !== p || !Jv(this.projectionDelta.x, this.prevProjectionDelta.x) || !Jv(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", v));
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    startAnimation(l) {
      ...
      this.notifyListeners("animationStart"), (c = this.currentAnimation) == null || c.stop(), (m = (f = this.resumingFrom) == null ? void 0 : f.currentAnimation) == null || m.stop(), this.pendingAnimation && (Pr(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = Ee.update(() => {
        Vl.hasAnimatedSinceResize = !0, this.motionValue || (this.motionValue = ls(0)), this.motionValue.jump(0, !1), this.currentAnimation = sE(this.motionValue, [0, 1e3], {
          ...l,
          velocity: 0,
          isSync: !0,
          onUpdate: (g) => {
    ...
    resetTree() {
      ...
      }), this.root.nodes.forEach(r0), this.root.sharedNodes.clear();
    }
  };
}
function fE(t) {
    ...
    if (!t.resumeFrom) {
      ...
      if (d && !d.resumeFrom) {
        ...
        if (p && v) {
          ...
          const T = nt();
          uu(T, r, v.layoutBox, w), eS(S, T) || (g = !0), d.options.layoutRoot && (t.relativeTarget = T, t.relativeTargetOrigin = S, t.relativeParent = d);
        }
      }
    }
...
function AE(t, e, n, r) {
  a0(t.x, e.x, n.x, r), a0(t.y, e.y, n.y, r);
}
function kE(t) {
...
const bE = {
  duration: 0.45,
  ease: [0.4, 0, 0.1, 1]
}, l0 = (t) => typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t), u0 = l0("applewebkit/") && !l0("chrome/") ? Math.round : un;
function c0(t) {
  t.min = u0(t.min), t.max = u0(t.max);
}
function CE(t) {
  c0(t.x), c0(t.y);
}
function sS(t, e, n) {
  return t === "position" || t === "preserve-aspect" && !KP(Xv(e), Xv(n), 0.2);
}
function PE(t) {
  var e;
    ...
    if (n)
      return () => {
        for (let s = 0; s < r.length; s++) {
          const a = r[s];
          typeof a == "function" ? a() : d0(t[s], null);
        }
      };
  };
}
function RE(...t) {
  return E.useCallback(ME(...t), t);
}
...
function IE({ children: t, isPresent: e, anchorX: n, anchorY: r, root: s, pop: a }) {
  ...
  const l = E.useId(), c = E.useRef(null), f = E.useRef({
    ...
    bottom: 0,
    direction: "ltr"
  }), { nonce: m } = E.useContext(lp), g = ((p = t.props) == null ? void 0 : p.ref) ?? (t == null ? void 0 : t.ref), d = RE(c, g);
  return E.useInsertionEffect(() => {
    ...
    if (e || a === !1 || !c.current || !v || !w)
      return;
    const M = C === "rtl", P = n === "left" ? M ? `right: ${A}` : `left: ${T}` : M ? `left: ${T}` : `right: ${A}`, $ = r === "bottom" ? `bottom: ${b}` : `top: ${S}`;
  ...
  }, [e]), _.jsx(NE, { isPresent: e, childRef: c, sizeRef: f, pop: a, children: a === !1 ? t : E.cloneElement(t, { ref: d }) });
}
const DE = ({ children: t, initial: e, isPresent: n, onExitComplete: r, custom: s, presenceAffectsLayout: a, mode: l, anchorX: c, anchorY: f, root: m }) => {
  const g = zh(jE), d = E.useId();
  let p = !0, v = E.useMemo(() => (p = !1, {
    id: d,
    initial: e,
    isPresent: n,
    custom: s,
  ...
  return a && p && (v = { ...v }), E.useMemo(() => {
    g.forEach((w, S) => g.set(S, !1));
  }, [n]), E.useEffect(() => {
    !n && !g.size && r && r();
  }, [n]), t = _.jsx(IE, { pop: l === "popLayout", isPresent: n, anchorX: c, anchorY: f, root: m, children: t }), _.jsx(Cu.Provider, { value: v, children: t });
};
function jE() {
...
const Xo = ({ children: t, custom: e, initial: n = !0, onExitComplete: r, presenceAffectsLayout: s = !0, mode: a = "sync", propagate: l = !1, anchorX: c = "left", anchorY: f = "top", root: m }) => {
  const [g, d] = aS(l), p = E.useMemo(() => f0(t), [t]), v = l && !g ? [] : p.map(Sl), w = E.useRef(!0), S = E.useRef(p), T = zh(() => /* @__PURE__ */ new Map()), A = E.useRef(/* @__PURE__ */ new Set()), [b, C] = E.useState(p), [M, P] = E.useState(p);
  j_(() => {
  ...
  if (p !== b) {
    ...
    return a === "wait" && $.length && (O = $), P(f0(O)), C(p), null;
  }
  const { forceRender: I } = E.useContext(Lh);
  return _.jsx(_.Fragment, { children: M.map((O) => {
    const L = Sl(O), U = l && !g ? !1 : p === M || v.includes(L), q = () => {
      ...
      T.forEach((ne) => {
        ne || (ee = !1);
      }), ee && (I == null || I(), P(S.current), l && (d == null || d()), r && r());
    };
...
}, lS = E.createContext({ strict: !1 }), h0 = {
  animation: [
    "animate",
    "variants",
    "whileHover",
...
let cS = (t) => !cu(t);
function zE(t) {
  typeof t == "function" && (cS = (e) => e.startsWith("on") ? !cu(e) : t(e));
}
try {
...
function $E(t, e, n) {
  const r = {};
  for (const s in t)
    s === "values" && typeof t.values == "object" || ft(t[s]) || (cS(s) || n === !0 && cu(s) || !e && !cu(s) || // If trying to use native HTML drag events, forward drag listeners
    t.draggable && s.startsWith("onDrag")) && (r[s] = t[s]);
  return r;
}
const Ru = /* @__PURE__ */ E.createContext({});
function VE(t, e) {
  if (Mu(t)) {
...
function BE(t) {
  const { initial: e, animate: n } = VE(t, E.useContext(Ru));
  return E.useMemo(() => ({ initial: e, animate: n }), [m0(e), m0(n)]);
}
function m0(t) {
...
function ZE(t, e, n, r) {
  const s = E.useMemo(() => {
    const a = fS();
    return Wx(a, e, Gx(r), t.transformTemplate, t.style), {
      ...a.attrs,
      style: { ...a.style }
    };
  }, [e]);
...
function KE(t, e, n, { latestValues: r }, s, a = !1, l) {
  const f = (l ?? cp(t) ? ZE : WE)(e, r, s, t), m = $E(e, typeof t == "string", a), g = t !== E.Fragment ? { ...m, ...f, ref: n } : {}, { children: d } = e, p = E.useMemo(() => ft(d) ? d.get() : d, [d]);
...
const hS = (t) => (e, n) => {
  const r = E.useContext(Ru), s = E.useContext(Cu), a = () => YE(t, e, r, s);
  return n ? a() : zh(a);
}, QE = /* @__PURE__ */ hS({
...
const pS = E.createContext({});
function Wi(t) {
  return t && typeof t == "object" && Object.prototype.hasOwnProperty.call(t, "current");
}
function tM(t, e, n, r, s, a) {
  var C, M;
  const { visualElement: l } = E.useContext(Ru), c = E.useContext(lS), f = E.useContext(Cu), m = E.useContext(lp), g = m.reducedMotion, d = m.skipAnimations, p = E.useRef(null), v = E.useRef(!1);
  ...
  const w = p.current, S = E.useContext(pS);
  w && !w.projection && s && (w.type === "html" || w.type === "svg") && nM(p.current, n, s, S);
  const T = E.useRef(!1);
  E.useInsertionEffect(() => {
    w && T.current && w.update(n, f);
  });
  const A = n[Tx], b = E.useRef(!!A && typeof window < "u" && !((C = window.MotionHandoffIsComplete) != null && C.call(window, A)) && ((M = window.MotionHasOptimisedAnimation) == null ? void 0 : M.call(window, A)));
  return j_(() => {
...
function Jd(t, { forwardMotionProps: e = !1, type: n } = {}, r, s) {
  r && OE(r);
  const a = n ? n === "svg" : cp(t), l = a ? XE : QE;
  function c(m, g) {
    let d;
    const p = {
      ...E.useContext(lp),
    ...
    return _.jsxs(Ru.Provider, { value: w, children: [d && w.visualElement ? _.jsx(d, { visualElement: w.visualElement, ...p }) : null, KE(t, m, eM(S, w.visualElement, g), S, v, e, a)] });
  }
...
function rM({ layoutId: t }) {
  const e = E.useContext(Lh).id;
  return e && t !== void 0 ? e + "-" + t : t;
}
function iM(t, e) {
  E.useContext(lS).strict;
}
function sM(t) {
...
const aM = (t, e) => e.isSVG ?? cp(t) ? new OP(e) : new RP(e, {
...
const fM = (t) => (e) => np(e) && t(e, Jo(e));
function Ao(t, e, n, r) {
  return Fo(t, e, fM(n), r);
}
const gS = ({ current: t }) => t ? t.ownerDocument.defaultView : null, g0 = (t, e) => Math.abs(t - e);
function hM(t, e) {
  const n = g0(t.x, e.x), r = g0(t.y, e.y);
...
class yS {
  constructor(e, n, { transformPagePoint: r, contextWindow: s = window, dragSnapToOrigin: a = !1, distanceThreshold: l = 3, element: c } = {}) {
    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.lastRawMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.scrollPositions = /* @__PURE__ */ new Map(), this.removeScrollListeners = null, this.onElementScroll = (v) => {
      ...
      const v = ef(this.lastMoveEventInfo, this.history), w = this.startEvent !== null, S = hM(v.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
      if (!w && !S)
        return;
      const { point: T } = v, { timestamp: A } = dt;
      this.history.push({ ...T, timestamp: A });
      const { onStart: b, onMove: C } = this.handlers;
      w || (b && b(this.lastMoveEvent, v), this.startEvent = this.lastMoveEvent), C && C(this.lastMoveEvent, v);
  ...
  startScrollTracking(e) {
    ...
    for (; n; ) {
      ...
      (y0.has(r.overflowX) || y0.has(r.overflowY)) && this.scrollPositions.set(n, {
        x: n.scrollLeft,
        y: n.scrollTop
      }), n = n.parentElement;
    }
...
class TM {
  ...
  resolveConstraints() {
    ...
    e && Wi(e) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : e && r ? this.constraints = yM(r.layoutBox, e) : this.constraints = !1, this.elastic = SM(n), s !== this.constraints && !Wi(e) && r && this.constraints && !this.hasMutatedConstraints && Pn((l) => {
  ...
  resolveRefConstraints() {
    ...
    if (n) {
      const c = n(wP(l));
      this.hasMutatedConstraints = !!c, c && (l = zx(c));
    }
    return l;
  }
  startAnimation(e) {
  ...
  addListeners() {
    ...
    const s = () => {
      ...
      Wi(m) && m.current && (this.constraints = this.resolveRefConstraints(), r || (r = AM(e, m.current, () => this.scalePositionWithinConstraints())));
...
function _S(t) {
  const [e, n] = aS(), r = E.useContext(Lh);
  return _.jsx(PM, { ...t, layoutGroup: r, switchLayoutGroup: E.useContext(pS), isPresent: e, safeToRemove: n });
}
const EM = {
  pan: {
    Feature: CM
...
class MM extends Nr {
  mount() {
    ...
    e && (this.unmount = XC(e, (n, r) => (A0(this.node, r, "Start"), (s) => A0(this.node, s, "End"))));
  }
  unmount() {
  }
}
...
class NM extends Nr {
  mount() {
    ...
    this.unmount = iP(e, (s, a) => (k0(this.node, a, "Start"), (l, { success: c }) => k0(this.node, l, c ? "End" : "Cancel")), {
      useGlobalTarget: n,
...
const Qf = /* @__PURE__ */ new WeakMap(), rf = /* @__PURE__ */ new WeakMap(), IM = (t) => {
...
const WM = (() => {
  var g, d, p, v;
  const t = globalThis.window || globalThis, e = globalThis.document || {}, n = t.location || {}, r = String(t.SYNAPSE_DATA_API_PORT || ((d = (g = e.body) == null ? void 0 : g.dataset) == null ? void 0 : d.dataApiPort) || "3001").trim(), { protocol: s = "file:", hostname: a = "127.0.0.1", port: l = "" } = n, c = `http://${HM(a)}:${r || "3001"}`, f = String(t.SYNAPSE_DATA_API_BASE || ((v = (p = e.body) == null ? void 0 : p.dataset) == null ? void 0 : v.dataApiBase) || "").replace(/\/+$/, ""), m = `${s}//${n.host || (l ? `${a}:${l}` : a)}`.replace(/\/+$/, "");
  return f && !(b0(a) && l !== r && f === m) ? f : s === "file:" || b0(a) && l !== r ? c : `${s}//${n.host || a}`;
})(), ZM = new N_(WM), sf = Number((globalThis.window || globalThis).SYNAPSE_DATA_API_TIMEOUT_MS || 6e3), GM = Number.isFinite(sf) && sf > 0 ? sf : 6e3;
function KM(t, e) {
...
async function QM(t) {
  try {
    ...
    return KM("Synapse data API focus-session save skipped:", e), null;
  }
}
async function XM(t = 40) {
...
const wS = "synapse.focusRoom.sessions.v1", TS = "synapse.focusRoom.draft.v1", AS = "synapse.focusRoom.active-session.v1", du = 40;
let Xf = [];
...
function Nu(t = {}) {
  const e = eR(t == null ? void 0 : t.musicType), n = tR(t == null ? void 0 : t.ambientSound);
  return {
    musicTrack: e,
    ambientSound: n,
...
function sR(t = {}) {
  const e = rR(t), r = [
    ...
    const c = typeof a == "string" ? { excerpt: a, title: a } : ci(a), f = iR(e, c), m = Re(
...
function us(t = {}) {
  ...
  ), r = String(t.aiSummary || t.summary || t.fullSummary || ""), s = String(t.materialTitle || t.title || nR(r)), a = Re(t.sourceFingerprint || t.source_fingerprint || t.clientFingerprint || t.client_fingerprint), l = Re(t.clientFingerprint || t.client_fingerprint || a), c = ci(t.sections), f = Re(t.promptMode || t.prompt_mode) || "professor_mode", m = Re(t.detailLevel || t.detail_level), g = rt(t.flashcards || t.cards), d = rt(t.quizzes || t.quizHistory), p = rt(t.studyPlan || ((O = t.timeline) == null ? void 0 : O.events) || t.study_path), v = rt(t.progressHistory), w = rt(t.visualGallery || t.visual_gallery || t.visuals), S = rt(t.sources), T = rt(t.sourceItems), A = sR({ ...t, sources: S, sourceItems: T, sections: c }), b = t.mindMap || t.mind_map || t.brainstorm || null, C = t.uploadedContent || t.sourceText || t.source_text || "", M = rt(t.connections), P = t.createdAt || t.created_at || "", $ = t.updatedAt || t.updated_at || P, I = pp(r);
  return {
    materialId: n,
    materialTitle: s,
...
function th(...t) {
  ...
  return e.map(us).filter((s) => s.materialId || s.aiSummary).forEach((s) => {
    const a = C0(s), l = a.reduce((f, m) => f >= 0 ? f : r.has(m) ? r.get(m) : -1, -1);
    if (l >= 0) {
      const f = lR(n[l], s);
      n[l] = f, C0(f).forEach((m) => r.set(m, l));
      return;
    }
    const c = n.push(s) - 1;
...
function hR({ material: t, goal: e, durationMinutes: n }) {
  var g;
...
function ES(t, e) {
  ...
  } : delete r.materials[n], mR(r);
}
function MS(t) {
  return ES(t, null);
}
function hu() {
  const t = fp(wS, []), e = Array.isArray(t) ? t : [], n = /* @__PURE__ */ new Set();
...
function vR(t = {}) {
  ...
  }, persisted: !0 }, s = hu().filter((f) => f.sessionId !== r.sessionId), a = [r, ...s.map((f) => ({ ...f, persisted: !0 }))].slice(0, du), l = hp(wS, a), c = { ...r, persisted: l };
  return QM(c).catch((f) => {
...
var Kt = {
  ...
  overwrite: !1,
  delay: 0
}, gp, ht, Fe, an = 1e8, Ce = 1 / an, nh = Math.PI * 2, _R = nh / 4, xR = 0, NS = Math.sqrt, SR = Math.cos, wR = Math.sin, lt = function(e) {
...
}, _t = Array.isArray, TR = /random\([^)]+\)/g, AR = /,\s*/g, P0 = /(?:-?\.?\d|\.)+/gi, DS = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Qi = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, of = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, jS = /[+-]=-?[.\d]+/, kR = /[^,'"\[\]\s]+/gi, bR = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, Be, En, rh, _p, Yt = {}, pu = {}, FS, OS = function(e) {
  ...
  suppressEvents: !0
}, Sp = {}, kr = [], ih = {}, zS, Ht = {}, af = {}, E0 = 30, Wl = [], wp = "", Tp = function(e) {
  var n = e[0], r, s;
  ...
  var n = parseFloat(e);
  return (n || n === 0) && (e + "").match(kR).length < 2 ? n : lt(e) ? e.trim() : e;
}, US = function(e) {
  return e;
}, qt = function(e, n) {
  for (var r in n)
  ...
  var n = e.parent || Be, r = e.keyframes ? MR(_t(e.keyframes)) : qt;
  if (Dt(e.inherit))
    for (; n; )
  ...
  return n.parent && Er(n), n._start = Ve((qn(r) ? r : r || e !== Be ? rn(e, r, n) : e._time) + n._delay), n._end = Ve(n._start + (n.totalDuration() / Math.abs(n.timeScale()) || 0)), HS(e, n, "_first", "_last", e._sort ? "_start" : 0), oh(n) || (e._recent = n), s || WS(e, n), e._ts < 0 && Fu(e, e._tTime), e;
}, ZS = function(e, n) {
  ...
  var a = e.ratio, l = n < 0 || !n && (!e._start && DR(e) && !(!e._initted && oh(e)) || (e._ts < 0 || e._dp._ts < 0) && !oh(e)) ? 0 : 1, c = e._rDelay, f = 0, m, g, d;
  ...
  var s = e.labels, a = e._recent || OR, l = e.duration() >= an ? a.endTime(!1) : e._dur, c, f, m;
  ...
  return !lt(e) || !(n = bR.exec(e)) ? "" : n[1];
}, LR = function(e, n, r) {
  return Ir(r, function(s) {
    return ta(e, n, s);
  });
}, ah = [].slice, KS = function(e, n) {
  ...
  return Fe && !n && Fe.selector ? Fe.selector(e) : lt(e) && !r && (rh || !hs()) ? ah.call((n || _p).querySelectorAll(e), 0) : _t(e) ? zR(e, r) : KS(e) ? ah.call(e, 0) : e ? [e] : [];
}, lh = function(e) {
  ...
  return lt(s) ? g = d = {
    ...
    var S = (w || n).length, T = l[S], A, b, C, M, P, $, I, O, L;
    if (!T) {
      ...
      for (T = l[S] = [], A = f ? Math.min(L, S) * g - 0.5 : s % L, b = L === an ? 0 : f ? S * d / L - 0.5 : s / L | 0, I = 0, O = an, $ = 0; $ < S; $++)
        C = $ % L - A, M = b - ($ / L | 0), T[$] = P = m ? Math.abs(m === "y" ? M : C) : NS(C * C + M * M), P > I && (I = P), P < O && (O = P);
      s === "random" && YS(T), T.max = I - O, T.min = O, T.v = S = (parseFloat(n.amount) || parseFloat(n.each) * (L > S ? S - 1 : m ? m === "y" ? S / L : L : Math.max(L, S / L)) || 0) * (s === "edges" ? -1 : 1), T.b = S < 0 ? a - S : a, T.u = vt(n.amount || n.each) || 0, r = r && S < 0 ? XR(r) : r;
    }
  ...
  var s = n - e;
  return _t(e) ? JS(e, t(0, e.length), n) : Ir(r, function(a) {
    return (s + (a - e) % s) % s + e;
  });
}, HR = function t(e, n, r) {
  var s = n - e, a = s * 2;
  return _t(e) ? JS(e, t(0, e.length - 1), n) : Ir(r, function(l) {
    return l = (a + (l - e) % a) % a || 0, e + (l > s ? a - l : l);
  });
}, $o = function(e) {
  return e.replace(TR, function(n) {
    var r = n.indexOf("[") + 1, s = n.substring(r || 7, r ? n.indexOf("]") : n.length - 1).split(AR);
...
})(), ZR = /hsl[a]?\(/, s1 = function(e) {
  var n = e.join(" "), r;
  if (br.lastIndex = 0, br.test(n))
    return r = ZR.test(n), e[1] = D0(e[1], r), e[0] = D0(e[0], r, i1(e[1])), !0;
}, Vo, Wt = (function() {
  var t = Date.now, e = 500, n = 33, r = t(), s = r, a = 1e3 / 240, l = a, c = [], f, m, g, d, p, v, w = function S(T) {
    var A = t() - s, b = T === !0, C, M, P, $;
    if ((A > e || A < 0) && (r += A - n), s += A, P = s - r, C = P - l, (C > 0 || b) && ($ = ++d.frame, p = P - d.time * 1e3, d.time = P = P / 1e3, l += C + (C >= a ? 4 : a - C), M = 1), b || (f = m(S)), M)
  ...
  return d = {
    ...
    wake: function() {
      FS && (!rh && vp() && (En = rh = window, _p = En.document || {}, Yt.gsap = Lt, (En.gsapVersions || (En.gsapVersions = [])).push(Lt.version), OS(pu || En.GreenSockGlobals || !En.gsap && En || {}), t1.forEach(n1)), g = typeof requestAnimationFrame < "u" && requestAnimationFrame, f && d.sleep(), m = g || function(T) {
  ...
  return !Vo && Wt.wake();
}, xe = {}, GR = /^[\d.\-M][\d.\-,\s]/, KR = /["']/g, YR = function(e) {
  for (var n = {}, r = e.substr(1, e.length - 3).split(":"), s = r[0], a = 1, l = r.length, c, f, m; a < l; a++)
    f = r[a], c = a !== l - 1 ? f.lastIndexOf(",") : f.length, m = f.substr(0, c), n[s] = isNaN(m) ? m.replace(KR, "").trim() : +m, s = f.substr(c + 1).trim();
  return n;
}, qR = function(e) {
  ...
  return r && n.length > 1 && r.config ? r.config.apply(null, ~e.indexOf("{") ? [YR(n[1])] : qR(e).split(",").map(BS)) : xe._CE && GR.test(e) ? xe._CE("", e) : r;
}, XR = function(e) {
  return function(n) {
    return 1 - e(1 - n);
  };
}, ai = function(e, n) {
  return e && (Ze(e) ? e : xe[e] || QR(e)) || n;
}, fi = function(e, n, r, s) {
  ...
  var s = n >= 1 ? n : 1, a = (r || (e ? 0.3 : 0.45)) / (n < 1 ? n : 1), l = a / nh * (Math.asin(1 / s) || 0), c = function(g) {
    return g === 1 ? 1 : s * Math.pow(2, -10 * g) * wR((g - l) * a) + 1;
...
var a1 = function(e, n) {
  this.id = xR++, e._gsap = this, this.target = e, this.harness = n, this.get = n ? n.get : $S, this.set = n ? n.getSetter : Pp;
  ...
  return e.delay = function(r) {
    ...
    if (a && a.smoothChildTiming && this._ts) {
      for (Fu(this, r), !a._dp || a.parent || WS(a, this); a && a.parent; )
    ...
    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), r + R0(this)) % (this._dur + this._rDelay) || (r ? this._dur : 0), s) : this._time;
    ...
    return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - r : r) + R0(this), s) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
    ...
    return this._rts = +r || 0, this._ts = this._ps || r === -Ce ? 0 : this._rts, this.totalTime(ta(-Math.abs(this._delay), this.totalDuration(), a), s !== !1), ju(this), NR(this);
  }, e.paused = function(r) {
    ...
    return arguments.length ? (this._repeat = r === 1 / 0 ? -2 : r, N0(this)) : this._repeat === -2 ? 1 / 0 : this._repeat;
  }, e.repeatDelay = function(r) {
    if (arguments.length) {
      var s = this._time;
      return this._rDelay = r, N0(this), s ? this.time(s) : this;
    }
    return this._rDelay;
  }, e.yoyo = function(r) {
...
var Nt = /* @__PURE__ */ (function(t) {
  ...
  return n.to = function(s, a, l) {
    ...
    var c = this._time, f = this._dirty ? this.totalDuration() : this._tDur, m = this._dur, g = s <= 0 ? 0 : Ve(s), d = this._zTime < 0 != s < 0 && (this._initted || !m), p, v, w, S, T, A, b, C, M, P, $, I;
    if (this !== Be && g > f && s >= 0 && (g = f), g !== this._tTime || l || d) {
      if (c !== this._time && m && (g += this._time - c, s += this._time - c), p = g, M = this._start, C = this._ts, A = !C, d && (m || (c = this._zTime), (s || !a) && (this._zTime = s)), this._repeat) {
        ...
        if (p = Ve(g % T), g === f ? (S = this._repeat, p = m) : (P = Ve(g / T), S = ~~P, S && S === P && (p = m, S--), p > m && (p = m)), P = ds(this._tTime, T), !c && this._tTime && P !== S && this._tTime - P * T - this._dur <= 0 && (P = S), $ && S & 1 && (p = m - p, I = 1), S !== P && !this._lock) {
          var O = $ && P & 1, L = O === ($ && S & 1);
          if (S < P && (O = !O), c = O ? 0 : g % m ? m : g, this._lock = 1, this.render(c || (I ? 0 : Ve(S * T)), a, !m)._lock = 0, this._tTime = g, !a && this.parent && Zt(this, "onRepeat"), this.vars.repeatRefresh && !I && (this.invalidate()._lock = 1, P = S), c && c !== this._time || A !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (b = FR(this, Ve(c), Ve(p)), b && (g -= p - (p = b._start))), this._tTime = g, this._time = p, this._act = !!C, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = s, c = 0), !c && g && m && !a && !P && (Zt(this, "onStart"), this._tTime !== g))
        return this;
      if (p >= c && s >= 0)
        for (v = this._first; v; ) {
      ...
      this._onUpdate && !a && Zt(this, "onUpdate", !0), (g === f && this._tTime >= this.totalDuration() || !g && c) && (M === this._start || Math.abs(C) !== Math.abs(this._ts)) && (this._lock || ((s || !m) && (g === f && this._ts > 0 || !g && this._ts < 0) && Er(this, 1), !a && !(s < 0 && !c) && (g || c || !f) && (Zt(this, g === f && s >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(g < f && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, n.add = function(s, a) {
    var l = this;
    ...
    for (var l = [], c = ln(s), f = this._first, m = qn(a), g; f; )
      f instanceof Xe ? ER(f._targets, c) && (m ? (!Sr || f._initted && f._ts) && f.globalTime(0) <= a && f.globalTime(f.totalDuration()) > a : !a || f.isActive()) && l.push(f) : (g = f.getTweensOf(c, a)).length && l.push.apply(l, g), f = f._next;
    return l;
    ...
    return s === void 0 && (s = this._time), I0(this, rn(this, s));
  }, n.previousLabel = function(s) {
    return s === void 0 && (s = this._time), I0(this, rn(this, s), 1);
    ...
    if (Be._ts && (VS(Be, yu(s, Be)), zS = Wt.frame), Wt.frame >= E0) {
      E0 += Kt.autoSleep || 120;
      var a = Be._first;
...
var JR = function(e, n, r, s, a, l, c) {
  ...
  Ze(s) && (s = s(a || 0, e, l));
  var d = e[n], p = r !== "get" ? r : Ze(d) ? m ? e[n.indexOf("set") || !Ze(e["get" + n.substr(3)]) ? n : "get" + n.substr(3)](m) : e[n]() : d, v = Ze(d) ? m ? iN : d1 : Cp, w;
  if (lt(s) && (~s.indexOf("random(") && (s = $o(s)), s.charAt(1) === "=" && (w = ts(p, s) + (vt(p) || 0), (w || w === 0) && (s = w))), !g || p !== s || ch)
    return !isNaN(p * s) && s !== "" ? (w = new Ft(this._pt, e, n, +p || 0, s - (p || 0), typeof d == "boolean" ? oN : f1, 0, v), m && (w.fp = m), c && w.modifier(c, this, e), this._pt = w) : (!d && !(n in e) && xp(n, s), JR.call(this, e, n, p, s, v, f || Kt.stringFilter, m));
}, eN = function(e, n, r, s, a) {
  ...
  var c, f, m, g;
  if (Ht[e] && (c = new Ht[e]()).init(a, c.rawVars ? n[e] : eN(n[e], s, a, l, r), r, s, l) !== !1 && (r._pt = f = new Ft(r._pt, a, e, 0, 1, c.render, c, 0, c.priority), r !== Xi))
    for (m = r._ptLookup[r._targets.indexOf(a)], g = c._props.length; g--; )
      m[c._props[g]] = f;
  return c;
}, Sr, ch, bp = function t(e, n, r) {
  var s = e.vars, a = s.ease, l = s.startAt, c = s.immediateRender, f = s.lazy, m = s.onUpdate, g = s.runBackwards, d = s.yoyoEase, p = s.keyframes, v = s.autoRevert, w = e._dur, S = e._startAt, T = e._targets, A = e.parent, b = A && A.data === "nested" ? A.vars.targets : T, C = e._overwrite === "auto" && !gp, M = e.timeline, P = s.easeReverse || d, $, I, O, L, U, q, ee, ne, ie, ge, ce, fe, W;
  if (M && (!p || !a) && (a = "none"), e._ease = ai(a, Oo.ease), e._rEase = P && (ai(P) || e._ease), e._from = !M && !!s.runBackwards, e._from && (e.ratio = 1), !M || p && !s.stagger) {
    if (ne = T[0] ? si(T[0]).harness : 0, fe = ne && s[ne.prop], $ = gu(s, Sp), S && (S._zTime < 0 && S.progress(1), n < 0 && g && c && !v ? S.render(-1, !0) : S.revert(g && w ? Hl : CR), S._lazy = 0), l) {
    ...
    for (e._pt = e._ptCache = 0, f = w && Dt(f) || f && !w, I = 0; I < T.length; I++) {
      if (U = T[I], ee = U._gsap || Tp(T)[I]._gsap, e._ptLookup[I] = ge = {}, ih[ee.id] && kr.length && mu(), ce = b === T ? I : b.indexOf(U), ne && (ie = new ne()).init(U, fe || $, e, ce, b) !== !1 && (e._pt = L = new Ft(e._pt, U, ie.name, 0, 1, ie.render, ie, 0, ie.priority), ie._props.forEach(function(J) {
        ...
        for (O in $)
          Ht[O] && (ie = l1(O, $, e, ce, U, b)) ? ie.priority && (q = 1) : ge[O] = L = kp.call(e, U, O, "get", $[O], ce, b, 0, s.stringFilter);
      e._op && e._op[I] && e.kill(U, e._op[I]), C && e._pt && (Sr = e, Be.killTweensOf(U, ge, e.globalTime(n)), W = !e.parent, Sr = 0), e._pt && f && (ih[ee.id] = 1);
    }
    q && p1(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = m, e._initted = (!e._op || e._pt) && !W, p && n <= 0 && M.render(an, !0, !0);
}, tN = function(e, n, r, s, a, l, c, f) {
...
}, u1 = wp + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", c1 = {};
...
var Xe = /* @__PURE__ */ (function(t) {
  ...
  function e(r, s, a, l) {
    ...
    var f = c.vars, m = f.duration, g = f.delay, d = f.immediateRender, p = f.stagger, v = f.overwrite, w = f.keyframes, S = f.defaults, T = f.scrollTrigger, A = s.parent || Be, b = (_t(r) || IS(r) ? qn(r[0]) : "length" in s) ? [r] : ln(r), C, M, P, $, I, O, L, U;
    if (c._targets = b.length ? Tp(b) : Lo("GSAP target " + r + " not found. https://gsap.com", !Kt.nullTargetWarn) || [], c._ptLookup = [], c._overwrite = v, w || p || Al(m) || Al(g)) {
      ...
      }), C.kill(), C.parent = C._dp = Zn(c), C._start = 0, p || Al(m) || Al(g)) {
        if ($ = b.length, L = p && qS(p), Fn(p))
          for (I in p)
            ~u1.indexOf(I) && (U || (U = {}), U[I] = p[I]);
        for (M = 0; M < $; M++)
          P = gu(s, c1), P.stagger = 0, q && (P.easeReverse = q), U && cs(P, U), O = b[M], P.duration = +Co(m, Zn(c), M, O, b), P.delay = (+Co(g, Zn(c), M, O, b) || 0) - c._delay, !p && $ === 1 && P.delay && (c._delay = g = P.delay, c._start += g, P.delay = 0), C.to(O, P, L ? L(M, O, b) : 0), C._ease = xe.none;
        C.duration() ? m = g = 0 : c.timeline = 0;
      } else if (w) {
        ko(qt(C.vars.defaults, {
          ease: "none"
        })), C._ease = ai(w.ease || s.ease || "none");
        var ee = 0, ne, ie, ge;
        if (_t(w))
          ...
          P = {};
          for (I in w)
            I === "ease" || I === "easeEach" || rN(I, w[I], P, w.easeEach);
          for (I in P)
            for (ne = P[I].sort(function(ce, fe) {
              return ce.t - fe.t;
      ...
      c.timeline = 0;
    return v === !0 && !gp && (Sr = Zn(c), Be.killTweensOf(b), Sr = 0), Rn(A, Zn(c), a), s.reversed && c.reverse(), s.paused && c.paused(!0), (d || !m && !w && c._start === Ve(A._time) && Dt(d) && IR(Zn(c)) && A.data !== "nested") && (c._tTime = -Ce, c.render(Math.max(0, -g) || 0)), T && ZS(Zn(c), T), c;
  }
  var n = e.prototype;
  return n.render = function(s, a, l) {
    ...
    return this._initted || bp(this, m), g = this._ease(m / this._dur), tN(this, s, a, l, c, g, m, f) ? this.resetTo(s, a, l, c, 1) : (Fu(this, 0), this.parent || HS(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, n.kill = function(s, a) {
...
var Cp = function(e, n, r) {
  ...
  return Ze(e[n]) ? d1 : yp(e[n]) && e.setAttribute ? sN : Cp;
}, f1 = function(e, n) {
  ...
  function t(n, r, s, a, l, c, f, m, g) {
    this.t = r, this.s = a, this.c = l, this.p = s, this.r = c || f1, this.d = f || this, this.set = m || Cp, this.pr = g || 0, this._next = n, n && (n._prev = this);
  }
  var e = t.prototype;
  return e.modifier = function(r, s, a) {
    this.mSet = this.mSet || this.set, this.set = uN, this.m = r, this.mt = a, this.tween = s;
  }, t;
})();
...
Kt.stringFilter = s1;
var li = [], Zl = {}, cN = [], j0 = 0, dN = 0, df = function(e) {
  return (Zl[e] || cN).map(function(n) {
    return n();
  });
}, dh = function() {
  var e = Date.now(), n = [];
  e - j0 > 2 && (df("matchMediaInit"), li.forEach(function(r) {
  ...
  function t(n, r) {
    this.selector = r && lh(r), this.data = [], this._r = [], this.isReverted = !1, this.id = dN++, n && this.add(n);
  }
  var e = t.prototype;
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = ai(e.ease, Oo.ease)), M0(Oo, e || {});
  },
  config: function(e) {
    return M0(Kt, e || {});
  },
...
var hN = function(e, n) {
  ...
  for (s in n)
    for (a = r.length; a--; )
      l = e._ptLookup[a][s], l && (l = l.d) && (l._pt && (l = hN(l, s)), l && l.modifier && l.modifier(n[s], e, r[a], s));
}, ff = function(e, n) {
  return {
    name: e,
    headless: 1,
...
}, ff("roundProps", uh), ff("modifiers"), ff("snap", QS)) || vu;
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var F0, wr, ns, Mp, ni, O0, Rp, mN = function() {
  return typeof window < "u";
}, Qn = {}, Xr = 180 / Math.PI, rs = Math.PI / 180, zi = Math.atan2, L0 = 1e8, Np = /([A-Z])/g, gN = /(left|right|width|margin|padding|x)/i, yN = /[\s,\(]\S/, In = {
  ...
  if (this.tfm) {
    for (l in this.tfm)
      s[l] = this.tfm[l];
    s.svg && (s.renderTransform(), n.setAttribute("data-svg-origin", this.svgo || "")), a = Rp(), (!a || !a.isStart) && !r[Ue] && (v1(r), s.zOrigin && r[Ot] && (r[Ot] += " " + s.zOrigin + "px", s.zOrigin = 0, s.renderTransform()), s.uncache = 1);
  }
}, _1 = function(e, n) {
  var r = {
    target: e,
...
}, z0 = "O,Moz,ms,Ms,Webkit".split(","), ps = function(e, n, r) {
  var s = n || ni, a = s.style, l = 5;
  if (e in a && !r)
    return e;
  for (e = e.charAt(0).toUpperCase() + e.substr(1); l-- && !(z0[l] + e in a); )
    ;
  return l < 0 ? null : (l === 3 ? "ms" : l >= 0 ? z0[l] : "") + e;
}, ph = function() {
  mN() && window.document && (F0 = window, wr = F0.document, ns = wr.documentElement, ni = hh("div") || {
    style: {}
  }, hh("div"), Ue = ps(Ue), Ot = Ue + "Origin", ni.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", x1 = !!ps("perspective"), Rp = Lt.core.reverting, Mp = 1);
}, $0 = function(e) {
  ...
  return n && (n.width || n.height) || r || (n = $0(e)), n && !n.width && !n.x && !n.y ? {
    x: +V0(e, ["x", "cx", "x1"]) || 0,
    y: +V0(e, ["y", "cy", "y1"]) || 0,
    width: 0,
    height: 0
  ...
  var a = parseFloat(r) || 0, l = (r + "").trim().substr((a + "").length) || "px", c = ni.style, f = gN.test(n), m = e.tagName.toLowerCase() === "svg", g = (m ? "client" : "offset") + (f ? "Width" : "Height"), d = 100, p = s === "px", v = s === "%", w, S, T, A;
  if (s === l || !a || B0[s] || B0[l])
    return a;
  ...
  if (v && (n === "height" || n === "width")) {
    ...
    (v || l === "%") && !MN[Gt(S, "display")] && (c.position = Gt(e, "position")), S === e && (c.position = "static"), S.appendChild(ni), w = ni[g], S.removeChild(ni), c.position = "absolute";
  return f && v && (T = si(S), T.time = Wt.time, T.width = S[g]), Ye(p ? w * a / d : w && a ? d / w * a : 0);
}, Gn = function(e, n, r, s) {
  var a;
  return Mp || ph(), n in In && n !== "transform" && (n = In[n], ~n.indexOf(",") && (n = n.split(",")[0])), Qn[n] && n !== "transform" ? (a = Ho(e, s), a = n !== "transformOrigin" ? a[n] : a.svg ? a.origin : xu(Gt(e, Ot)) + " " + a.zOrigin + "px") : (a = e.style[n], (!a || a === "auto" || s || ~(a + "").indexOf("calc(")) && (a = _u[n] && _u[n](e, n, r) || Gt(e, n) || $S(e, n) || (n === "opacity" ? 1 : 0))), r && !~(a + "").trim().indexOf(" ") ? Rr(e, n, a, r) + r : a;
}, RN = function(e, n, r, s) {
  if (!r || r === "none") {
    var a = ps(n, e, 1), l = a && Gt(e, a, 1);
    l && l !== r ? (n = a, r = l) : n === "borderColor" && (r = Gt(e, "borderTopColor"));
  }
  var c = new Ft(this._pt, e.style, n, 0, 1, h1), f = 0, m = 0, g, d, p, v, w, S, T, A, b, C, M, P;
  if (c.b = r, c.e = s, r += "", s += "", s.substring(0, 6) === "var(--" && (s = Gt(e, s.substring(4, s.indexOf(")")))), s === "auto" && (S = e.style[n], e.style[n] = s, s = Gt(e, n) || s, S ? e.style[n] = S : Mr(e, n)), g = [r, s], s1(g), r = g[0], s = g[1], p = r.match(Qi) || [], P = s.match(Qi) || [], P.length) {
    for (; d = Qi.exec(s); )
      T = d[0], b = s.substring(f, d.index), w ? w = (w + 1) % 5 : (b.substr(-5) === "rgba(" || b.substr(-5) === "hsla(") && (w = 1), T !== (S = p[m++] || "") && (v = parseFloat(S) || 0, M = S.substr((v + "").length), T.charAt(1) === "=" && (T = ts(v, T) + M), A = parseFloat(T), C = T.substr((A + "").length), f = Qi.lastIndex - C.length, C || (C = C || Kt.units[n] || M, f === s.length && (s += C, c.e += C)), M !== C && (v = Rr(e, n, S, C) || 0), c._pt = {
        _next: c._pt,
        p: b || m === 1 ? b : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: v,
  ...
  return (r === "top" || r === "bottom" || s === "left" || s === "right") && (e = r, r = s, s = e), n[0] = U0[r] || r, n[1] = U0[s] || s, n.join(" ");
}, IN = function(e, n) {
  if (n.tween && n.tween._time === n.tween._dur) {
    ...
    f && (Mr(r, Ue), l && (l.svg && r.removeAttribute("transform"), s.scale = s.rotate = s.translate = "none", Ho(r, 1), l.uncache = 1, v1(s)));
  }
}, _u = {
  clearProps: function(e, n, r, s, a) {
    if (a.data !== "isFromStart") {
      var l = e._pt = new Ft(e._pt, n, r, 0, 0, IN);
...
}, Kr = "0deg", po = "0px", Yr = ") ", k1 = function(e, n) {
  var r = n || this, s = r.xPercent, a = r.yPercent, l = r.x, c = r.y, f = r.z, m = r.rotation, g = r.rotationY, d = r.rotationX, p = r.skewX, v = r.skewY, w = r.scaleX, S = r.scaleY, T = r.transformPerspective, A = r.force3D, b = r.target, C = r.zOrigin, M = "", P = A === "auto" && e && e !== 1 || A === !0;
  if (C && (d !== Kr || g !== Kr)) {
    var $ = parseFloat(g) * rs, I = Math.sin($), O = Math.cos($), L;
    $ = parseFloat(d) * rs, L = Math.cos($), l = hf(b, l, I * L * -C), c = hf(b, c, -Math.sin($) * -C), f = hf(b, f, O * L * -C + C);
  }
  T !== po && (M += "perspective(" + T + Yr), (s || a) && (M += "translate(" + s + "%, " + a + "%) "), (P || l !== po || c !== po || f !== po) && (M += f !== po || P ? "translate3d(" + l + ", " + c + ", " + f + ") " : "translate(" + l + ", " + c + Yr), m !== Kr && (M += "rotate(" + m + Yr), g !== Kr && (M += "rotateY(" + g + Yr), d !== Kr && (M += "rotateX(" + d + Yr), (p !== Kr || v !== Kr) && (M += "skew(" + p + ", " + v + Yr), (w !== 1 || S !== 1) && (M += "scale(" + w + ", " + S + Yr), b.style[Ue] = M || "translate(0, 0)";
}, jN = function(e, n) {
  var r = n || this, s = r.xPercent, a = r.yPercent, l = r.x, c = r.y, f = r.rotation, m = r.skewX, g = r.skewY, d = r.scaleX, p = r.scaleY, v = r.target, w = r.xOrigin, S = r.yOrigin, T = r.xOffset, A = r.yOffset, b = r.forceCSS, C = parseFloat(l), M = parseFloat(c), P, $, I, O, L;
  f = parseFloat(f), m = parseFloat(m), g = parseFloat(g), g && (g = parseFloat(g), m += g, f += g), f || m ? (f *= rs, m *= rs, P = Math.cos(f) * d, $ = Math.sin(f) * d, I = Math.sin(f - m) * -p, O = Math.cos(f - m) * p, m && (g *= rs, L = Math.tan(m - g), L = Math.sqrt(1 + L * L), I *= L, O *= L, g && (L = Math.tan(g), L = Math.sqrt(1 + L * L), P *= L, $ *= L)), P = Ye(P), $ = Ye($), I = Ye(I), O = Ye(O)) : (P = d, O = p, $ = I = 0), (C && !~(l + "").indexOf("px") || M && !~(c + "").indexOf("px")) && (C = Rr(v, "x", l, "px"), M = Rr(v, "y", c, "px")), (w || S || T || A) && (C = Ye(C + w - (w * P + S * I) + T), M = Ye(M + S - (w * $ + S * O) + A)), (s || a) && (L = v.getBBox(), C = Ye(C + s / 100 * L.width), M = Ye(M + a / 100 * L.height)), L = "matrix(" + P + "," + $ + "," + I + "," + O + "," + C + "," + M + ")", v.setAttribute("transform", L), b && (v.style[Ue] = L);
}, FN = function(e, n, r, s, a) {
  var l = 360, c = lt(a), f = parseFloat(a) * (c && ~a.indexOf("rad") ? Xr : 1), m = f - s, g = s + m + "deg", d, p;
  return c && (d = a.split("_")[1], d === "short" && (m %= l, m !== m % (l / 2) && (m += m < 0 ? l : -l)), d === "cw" && m < 0 ? m = (m + l * L0) % l - ~~(m / l) * l : d === "ccw" && m > 0 && (m = (m - l * L0) % l - ~~(m / l) * l)), e._pt = p = new Ft(e._pt, n, r, s, m, vN), p.e = g, p.u = "deg", e._props.push(r), p;
}, W0 = function(e, n) {
  for (var r in n)
    e[r] = n[r];
  return e;
}, ON = function(e, n, r) {
  var s = W0({}, r._gsap), a = "perspective,force3D,transformOrigin,svgOrigin", l = r.style, c, f, m, g, d, p, v, w;
...
var b1 = {
  ...
  init: function(e, n, r, s, a) {
    var l = this._props, c = e.style, f = r.vars.startAt, m, g, d, p, v, w, S, T, A, b, C, M, P, $, I, O, L;
    Mp || ph(), this.styles = this.styles || _1(e), O = this.styles.props, this.tween = r;
    for (S in n)
      if (S !== "autoRound" && (g = n[S], !(Ht[S] && l1(S, n, r, s, e, a)))) {
        if (v = typeof g, w = _u[S], v === "function" && (g = g.call(r, s, e, a), v = typeof g), v === "string" && ~g.indexOf("random(") && (g = $o(g)), w)
          ...
          if (f && S in f ? (m = typeof f[S] == "function" ? f[S].call(r, s, e, a) : f[S], lt(m) && ~m.indexOf("random(") && (m = $o(m)), vt(m + "") || m === "auto" || (m += Kt.units[S] || vt(Gn(e, S)) || ""), (m + "").charAt(1) === "=" && (m = Gn(e, S))) : m = Gn(e, S), p = parseFloat(m), b = v === "string" && g.charAt(1) === "=" && g.substr(0, 2), b && (g = g.substr(2)), d = parseFloat(g), S in In && (S === "autoAlpha" && (p === 1 && Gn(e, "visibility") === "hidden" && d && (p = 0), O.push("visibility", 0, c.visibility), Tr(this, c, "visibility", p ? "inherit" : "hidden", d ? "inherit" : "hidden", !d)), S !== "scale" && S !== "transform" && (S = In[S], ~S.indexOf(",") && (S = S.split(",")[0]))), C = S in Qn, C) {
            ...
            if (M || (P = e._gsap, P.renderTransform && !n.parseTransform || Ho(e, n.parseTransform), $ = n.smoothOrigin !== !1 && P.smooth, M = this._pt = new Ft(this._pt, c, Ue, 0, 1, P.renderTransform, P, 0, -1), M.dep = 1), S === "scale")
              this._pt = new Ft(this._pt, P, "scaleY", P.scaleY, (b ? ts(P.scaleY, b + d) : d) - P.scaleY || 0, fh), this._pt.u = 0, l.push("scaleY", S), S += "X";
            else if (S === "transformOrigin") {
              O.push(Ot, 0, c[Ot]), g = NN(g), P.svg ? mh(e, g, 0, $, 0, this) : (A = parseFloat(g.split(" ")[2]) || 0, A !== P.zOrigin && Tr(this, P, "zOrigin", P.zOrigin, A), Tr(this, c, S, xu(m), xu(g)));
              continue;
            } else if (S === "svgOrigin") {
              mh(e, g, 1, $, 0, this);
              continue;
            } else if (S in T1) {
              FN(this, P, S, p, b ? ts(p, b + g) : g);
              continue;
            } else if (S === "smoothOrigin") {
              Tr(this, P, "smooth", P.smooth, g);
              continue;
            } else if (S === "force3D") {
              P[S] = g;
              continue;
          ...
          if (C || (d || d === 0) && (p || p === 0) && !yN.test(g) && S in c)
            T = (m + "").substr((p + "").length), d || (d = 0), A = vt(g) || (S in Kt.units ? Kt.units[S] : T), T !== A && (p = Rr(e, S, m, A)), this._pt = new Ft(this._pt, C ? P : c, S, p, (b ? ts(p, b + d) : d) - p, !C && (A === "px" || S === "zIndex") && n.autoRound !== !1 ? SN : fh), this._pt.u = A || 0, C && L !== g ? (this._pt.b = m, this._pt.e = L, this._pt.r = xN) : T !== A && A !== "%" && (this._pt.b = m, this._pt.r = _N);
          else if (S in c)
            RN.call(this, e, S, m, b ? b + g : g);
          else if (S in e)
  ...
  getSetter: function(e, n, r) {
    var s = In[n];
    return s && s.indexOf(",") < 0 && (n = s), n in Qn && n !== Ot && (e._gsap.x || Gn(e, "x")) ? r && O0 === r ? n === "scale" ? kN : AN : (O0 = r || {}) && (n === "scale" ? bN : CN) : e.style && !yp(e.style[n]) ? wN : ~n.indexOf("-") ? TN : Pp(e, n);
  },
  core: {
    _removeProperty: Mr,
    _getMatrix: Ip
 ...
 */
const zN = (t) => t.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), $N = (t) => t.replace(
  /^([A-Z])|[\s-_]+(\w)/g,
  (e, n, r) => r ? r.toUpperCase() : n.toLowerCase()
), Z0 = (t) => {
  const e = $N(t);
  return e.charAt(0).toUpperCase() + e.slice(1);
}, P1 = (...t) => t.filter((e, n, r) => !!e && e.trim() !== "" && r.indexOf(e) === n).join(" ").trim(), VN = (t) => {
  for (const e in t)
...
const Oe = (t, e) => {
  const n = E.forwardRef(
    ({ className: r, ...s }, a) => E.createElement(UN, {
      ref: a,
      iconNode: e,
      className: P1(
        `lucide-${zN(Z0(t))}`,
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const cI = [["polygon", { points: "6 3 20 12 6 21 6 3", key: "1oa8hb" }]], N1 = Oe("play", cI);
/**
 * @license lucide-react v0.515.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const K0 = (t) => {
  const e = TI(t), n = (r) => kI(e, r);
  return Object.assign(n, e), n;
}, bI = ((t) => t ? K0(t) : K0);
var E_;
const yh = ((E_ = ea[0]) == null ? void 0 : E_.id) || "morning-window", Op = kS[0] || 25, CI = 10, Lp = 180, PI = 0, EI = 100, vh = ["materials", "notes", "sources", "chat", "quiz", "flashcards", "mindmap", "plan", "workspace", "history"], _h = new Set(vh), is = {
  type: "spring",
  stiffness: 120,
  damping: 18,
  mass: 0.8
...
function ys(t) {
  return (Array.isArray(t == null ? void 0 : t.quizzes) ? t.quizzes : []).flatMap((n) => FI(n).map((r) => {
    var s;
    return {
      ...r,
...
function vs(t) {
  ...
  return Array.isArray(e) && e.length ? e.map(OI).filter(Boolean) : na(t) === "true_false" ? ["True", "False"] : [];
}
function wh(t) {
...
function ZI(t, e = {}) {
  const n = gs(e.selectedScene), r = HI(t == null ? void 0 : t.materialId), s = zp(r == null ? void 0 : r.selectedScene) ? r.selectedScene : n.id, a = gs(s), l = String((r == null ? void 0 : r.musicType) || a.musicType || "Deep Focus"), c = String((r == null ? void 0 : r.ambientSound) || a.ambientSound || "Nature"), f = ms(r == null ? void 0 : r.musicVolume, e.musicVolume ?? 60), m = ms(r == null ? void 0 : r.ambientVolume, e.ambientVolume ?? 50), g = Ou(r == null ? void 0 : r.durationMinutes, e.pomodoroDuration ?? Op), d = String((r == null ? void 0 : r.studyGoal) || `Study ${(t == null ? void 0 : t.materialTitle) || "this material"}`), p = O1(r == null ? void 0 : r.studyPlan), v = p.length ? p : xh(t, d, g), w = WI(r), S = String((r == null ? void 0 : r.workspaceNotes) || ""), T = (r == null ? void 0 : r.workspaceUpdatedAt) || (r == null ? void 0 : r.updatedAt) || "";
  return {
    selectedScene: s,
    musicType: l,
    ambientSound: c,
...
const H = bI((t, e) => {
  ...
  return {
    ...
    hydrateFocusRoute(r, s, { preserveSession: a = !1 } = {}) {
      ...
      const m = l.selectedMaterialId === f, g = m && a ? null : GI(f), d = m && a ? {} : ZI(s, l), p = m && a ? {} : {
        timerStatus: "idle",
        elapsedSeconds: 0,
        startedAt: null,
        currentSession: null,
    ...
    endSession() {
      var m;
      const r = e(), s = r.selectedMaterial || dR(r.selectedMaterialId);
      if (!s) return;
      const a = (/* @__PURE__ */ new Date()).toISOString(), l = _o(r.pomodoroDuration), c = l ? Math.min(l, r.elapsedSeconds) : r.elapsedSeconds, f = vR({
    ...
    checkQuizQuestion(r) {
      ...
      if (!l) return;
      const c = String(a), f = e(), m = Object.prototype.hasOwnProperty.call(f.quizAnswers, c) ? f.quizAnswers[c] : "", g = $I(l, m), d = V1(l);
      t({
        quizChecked: {
          ...f.quizChecked,
          [c]: {
    ...
    async askAssistant(r) {
      ...
      try {
        const f = await KI(s, c, l, a.assistantContext);
        t((m) => ({
          chatMessages: vo([
            ...m.chatMessages,
...
function YI({ scene: t, active: e, onSelect: n }) {
  ...
  return (e) => {
    ...
    if (n)
      return () => {
        for (let s = 0; s < r.length; s++) {
          const a = r[s];
          typeof a == "function" ? a() : J0(t[s], null);
        }
      };
  };
}
function kt(...t) {
  return E.useCallback(qI(...t), t);
}
function QI(t, e) {
  const n = E.createContext(e);
  n.displayName = t + "Context";
  const r = (a) => {
    const { children: l, ...c } = a, f = E.useMemo(() => c, Object.values(c));
    return /* @__PURE__ */ _.jsx(n.Provider, { value: f, children: l });
  };
  r.displayName = t + "Provider";
  function s(a) {
    const l = E.useContext(n);
    if (l) return l;
...
function ra(t, e = []) {
  ...
  function r(a, l) {
    ...
    const m = (d) => {
      var A;
      const { scope: p, children: v, ...w } = d, S = ((A = p == null ? void 0 : p[t]) == null ? void 0 : A[f]) || c, T = E.useMemo(() => w, Object.values(w));
      return /* @__PURE__ */ _.jsx(S.Provider, { value: T, children: v });
    };
    m.displayName = a + "Provider";
    function g(d, p) {
      var S;
      const v = ((S = p == null ? void 0 : p[t]) == null ? void 0 : S[f]) || c, w = E.useContext(v);
      if (w) return w;
...
var _s = globalThis != null && globalThis.document ? E.useLayoutEffect : () => {
}, JI = Oh[" useInsertionEffect ".trim().toString()] || _s;
function Lu({
  prop: t,
  defaultProp: e,
  onChange: n = () => {
...
var n2 = E.createContext(void 0);
function $p(t) {
  const e = E.useContext(n2);
  return t || e || "ltr";
}
function r2(t) {
...
function Au(t) {
  const e = E.forwardRef((n, r) => {
    ...
    const f = [];
    e_(s) && typeof bl == "function" && (s = bl(s._payload)), E.Children.forEach(s, (p) => {
      var v;
      if (u2(p)) {
        c = !0;
        const w = p;
        let S = "child" in w.props ? w.props.child : w.props.children;
        e_(S) && typeof bl == "function" && (S = bl(S._payload)), l = o2(w, S), f.push((v = l == null ? void 0 : l.props) == null ? void 0 : v.children);
      } else
        f.push(p);
    ...
    const m = l ? l2(l) : void 0, g = kt(r, m);
    if (!l) {
      if (s || s === 0)
        throw new Error(
          c ? h2(t) : f2(t)
...
function u2(t) {
  return E.isValidElement(t) && typeof t.type == "function" && "__radixId" in t.type && t.type.__radixId === s2;
}
var c2 = Symbol.for("react.lazy");
function e_(t) {
  return t != null && typeof t == "object" && "$$typeof" in t && t.$$typeof === c2 && "_payload" in t && d2(t._payload);
}
function d2(t) {
  return typeof t == "object" && t !== null && "then" in t;
}
var f2 = (t) => `${t} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`, h2 = (t) => `${t} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`, bl = Oh[" use ".trim().toString()], p2 = [
  "a",
  "button",
  "div",
  "form",
  ...
  const n = /* @__PURE__ */ Au(`Primitive.${e}`), r = E.forwardRef((s, a) => {
...
function G1(t) {
  const e = t + "CollectionProvider", [n, r] = ra(e), [s, a] = n(
    ...
    const { scope: T, children: A } = S, b = E.useRef(null), C = E.useRef(/* @__PURE__ */ new Map()).current;
    return /* @__PURE__ */ _.jsx(s, { scope: T, itemMap: C, collectionRef: b, children: A });
  };
  l.displayName = e;
  const c = t + "CollectionSlot", f = /* @__PURE__ */ Au(c), m = E.forwardRef(
    (S, T) => {
  ...
  m.displayName = c;
  const g = t + "CollectionItemSlot", d = "data-radix-collection-item", p = /* @__PURE__ */ Au(g), v = E.forwardRef(
    (S, T) => {
      const { scope: A, children: b, ...C } = S, M = E.useRef(null), P = kt(T, M), $ = a(g, A);
      return E.useEffect(() => ($.itemMap.set(M, { ref: M, ...C }), () => void $.itemMap.delete(M))), /* @__PURE__ */ _.jsx(p, { [d]: "", ref: P, children: b });
    }
  );
  v.displayName = g;
  function w(S) {
...
}, As = "Slider", [Ah, g2, y2] = G1(As), [Vp] = ra(As, [
  y2
]), [v2, ia] = Vp(As), Q1 = E.forwardRef(
  (t, e) => {
    const {
      name: n,
      min: r = 0,
      ...
      form: w,
      ...S
    } = t, T = E.useRef(/* @__PURE__ */ new Set()), A = E.useRef(0), b = E.useRef(!1), M = l === "horizontal" ? _2 : x2, [P = [], $] = Lu({
      prop: g,
      defaultProp: m,
      onChange: (ee) => {
        var ie;
    ...
    function q(ee, ne, { commit: ie } = { commit: !1 }) {
      const ge = P2(a), ce = E2(Math.round((ee - r) / a) * a + r, ge), fe = W1(ce, [r, s]);
      $((W = []) => {
        const J = w2(W, fe, ne);
        if (C2(J, f * a)) {
      ...
      v2,
      {
        ...
        children: /* @__PURE__ */ _.jsx(Ah.Provider, { scope: t.__scopeSlider, children: /* @__PURE__ */ _.jsx(Ah.Slot, { scope: t.__scopeSlider, children: /* @__PURE__ */ _.jsx(
          M,
          {
            ...
            onEndKeyDown: () => {
              c || (b.current = !0, q(s, P.length - 1, { commit: !0 }));
            },
            onStepKeyDown: ({ event: ee, direction: ne }) => {
              if (!c) {
                b.current = !0;
                const ce = K1.includes(ee.key) || ee.shiftKey && Y1.includes(ee.key) ? 10 : 1, fe = A.current, W = P[fe], J = a * ce * ne;
                q(W + J, fe, { commit: !0 });
              }
            }
          }
...
var [X1, J1] = Vp(As, {
  ...
  (t, e) => {
    const {
      ...
      onStepKeyDown: m,
      ...g
    } = t, [d, p] = E.useState(null), v = kt(e, (C) => p(C)), w = E.useRef(void 0), S = $p(s), T = S === "ltr", A = T && !a || !T && a;
    function b(C) {
      const M = w.current || d.getBoundingClientRect(), P = [0, M.width], I = Bp(P, A ? [n, r] : [r, n]);
      ...
      X1,
      {
        ...
        children: /* @__PURE__ */ _.jsx(
          ew,
          {
            ...
            onStepKeyDown: (C) => {
              const P = q1[A ? "from-left" : "from-right"].includes(C.key);
  ...
  (t, e) => {
    const {
      ...
      onStepKeyDown: f,
      ...m
    } = t, g = E.useRef(null), d = kt(e, g), p = E.useRef(void 0), v = !s;
    function w(S) {
      const T = p.current || g.current.getBoundingClientRect(), A = [0, T.height], C = Bp(A, v ? [r, n] : [n, r]);
...
), tw = "SliderTrack", nw = E.forwardRef(
  (t, e) => {
...
nw.displayName = tw;
var kh = "SliderRange", rw = E.forwardRef(
  (t, e) => {
    const { __scopeSlider: n, ...r } = t, s = ia(kh, n), a = J1(kh, n), l = E.useRef(null), c = kt(e, l), f = s.values.length, m = s.values.map(
      (p) => fw(p, s.min, s.max)
...
rw.displayName = kh;
var iw = "SliderThumb", [S2, sw] = Vp(iw), ow = "SliderThumbProvider";
function aw(t) {
  const {
    __scopeSlider: e,
    name: n,
  ...
  } = t, a = ia(ow, e), l = g2(e), [c, f] = E.useState(null), m = E.useMemo(
    () => c ? l().findIndex((T) => T.ref.current === c) : -1,
    [l, c]
  ), g = i2(c), d = c ? !!a.form || !!c.closest("form") : !0, p = a.values[m], v = n ?? (a.name ? a.name + (a.values.length > 1 ? "[]" : "") : void 0), w = p === void 0 ? 0 : fw(p, a.min, a.max);
  E.useEffect(() => {
    if (c)
  ...
  return /* @__PURE__ */ _.jsx(S2, { scope: e, ...S, children: M2(s) ? s(S) : r });
}
aw.displayName = ow;
var Kl = "SliderThumbTrigger", lw = E.forwardRef(
  (t, e) => {
    const { __scopeSlider: n, ...r } = t, s = ia(Kl, n), a = J1(Kl, n), { index: l, value: c, percent: f, size: m, onThumbChange: g } = sw(
      Kl,
      n
    ), d = kt(e, (S) => g(S)), p = T2(l, s.values.length), v = m == null ? void 0 : m[a.size], w = v ? k2(v, f, a.direction) : 0;
    return /* @__PURE__ */ _.jsx(
      "span",
      {
        style: {
...
uw.displayName = iw;
var cw = "SliderBubbleInput", dw = E.forwardRef(
  ({ __scopeSlider: t, ...e }, n) => {
    const { value: r, name: s, form: a } = sw(cw, t), l = E.useRef(null), c = kt(l, n), f = r2(r);
    return E.useEffect(() => {
      const m = l.current;
      if (!m) return;
...
function t_({ label: t, icon: e, value: n, onChange: r }) {
...
function hw({ audioState: t }) {
  ...
  return /* @__PURE__ */ _.jsxs("div", { className: "sound-panel", children: [
    ...
    /* @__PURE__ */ _.jsx(
      ...
      {
        label: "Music volume",
        icon: /* @__PURE__ */ _.jsx(_I, { size: 16, "aria-hidden": "true" }),
        value: r,
    ...
    /* @__PURE__ */ _.jsx(
      t_,
      {
        ...
        icon: /* @__PURE__ */ _.jsx(SI, { size: 16, "aria-hidden": "true" }),
        value: s,
...
function R2({ audioState: t, onWorkspace: e, onHistory: n }) {
  var g;
    ...
    /* @__PURE__ */ _.jsxs(Po, { className: "focus-setup-controls", children: [
      ...
      /* @__PURE__ */ _.jsx("div", { className: "duration-grid", "aria-label": "Pomodoro duration", children: kS.map((d) => /* @__PURE__ */ _.jsxs(
        de,
        {
          ...
          onClick: () => c(d),
          children: [
            /* @__PURE__ */ _.jsx(KN, { size: 16, "aria-hidden": "true" }),
            " ",
            d,
            "m"
          ]
  ...
  return /* @__PURE__ */ _.jsxs(
    cn.article,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _.jsx("div", { className: "timer-value", "aria-live": "polite", children: II(S) }),
...
function D2() {
  return /* @__PURE__ */ _.jsx(I2, {});
}
function j2({ onWorkspace: t, onHistory: e }) {
  var v, w, S, T;
  ...
  return /* @__PURE__ */ _.jsxs("header", { className: "top-nav", children: [
    ...
    /* @__PURE__ */ _.jsxs("nav", { className: "top-nav-actions", "aria-label": "Focus Room controls", children: [
      ...
      /* @__PURE__ */ _.jsxs(de, { className: "focus-command-btn", onClick: () => l("music"), title: "Sound controls", children: [
        /* @__PURE__ */ _.jsx(aI, { size: 16, "aria-hidden": "true" }),
        " ",
...
function F2({ audioState: t }) {
  ...
  return /* @__PURE__ */ _.jsxs("div", { className: "bottom-dock liquid-glass", "aria-label": "Floating session controls", children: [
    ...
    /* @__PURE__ */ _.jsxs(de, { variant: e ? "primary" : "ghost", onClick: n, children: [
      e ? /* @__PURE__ */ _.jsx(gh, { size: 16, "aria-hidden": "true" }) : /* @__PURE__ */ _.jsx(N1, { size: 16, "aria-hidden": "true" }),
...
var O2 = Oh[" useId ".trim().toString()] || (() => {
}), L2 = 0;
function Eo(t) {
  const [e, n] = E.useState(O2());
  return _s(() => {
    n((r) => r ?? String(L2++));
  }, [t]), t || (e ? `radix-${e}` : "");
}
...
var $2 = "DismissableLayer", bh = "dismissableLayer.update", V2 = "dismissableLayer.pointerDownOutside", B2 = "dismissableLayer.focusOutside", n_, pw = E.createContext({
  ...
  (t, e) => {
    const {
      ...
      onDismiss: c,
      ...f
    } = t, m = E.useContext(pw), [g, d] = E.useState(null), p = (g == null ? void 0 : g.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, v] = E.useState({}), w = kt(e, (I) => d(I)), S = Array.from(m.layers), [T] = [...m.layersWithOutsidePointerEventsDisabled].slice(-1), A = S.indexOf(T), b = g ? S.indexOf(g) : -1, C = m.layersWithOutsidePointerEventsDisabled.size > 0, M = b >= A, P = W2((I) => {
    ...
    return z2((I) => {
      ...
      if (g)
        return n && (m.layersWithOutsidePointerEventsDisabled.size === 0 && (n_ = p.body.style.pointerEvents, p.body.style.pointerEvents = "none"), m.layersWithOutsidePointerEventsDisabled.add(g)), m.layers.add(g), r_(), () => {
          n && (m.layersWithOutsidePointerEventsDisabled.delete(g), m.layersWithOutsidePointerEventsDisabled.size === 0 && (p.body.style.pointerEvents = n_));
        };
    }, [g, p, n, m]), E.useEffect(() => () => {
      g && (m.layers.delete(g), m.layersWithOutsidePointerEventsDisabled.delete(g), r_());
    }, [g, m]), E.useEffect(() => {
      const I = () => v({});
...
mw.displayName = $2;
var U2 = "DismissableLayerBranch", H2 = E.forwardRef((t, e) => {
  const n = E.useContext(pw), r = E.useRef(null), s = kt(e, r);
  return E.useEffect(() => {
    const a = r.current;
    if (a)
...
H2.displayName = U2;
function W2(t, e = globalThis == null ? void 0 : globalThis.document) {
  const n = xs(t), r = E.useRef(!1), s = E.useRef(() => {
  });
  return E.useEffect(() => {
    const a = (c) => {
...
function Z2(t, e = globalThis == null ? void 0 : globalThis.document) {
  const n = xs(t), r = E.useRef(!1);
  return E.useEffect(() => {
    const s = (a) => {
      a.target && !r.current && gw(B2, n, { originalEvent: a }, {
        discrete: !1
      });
    };
...
function gw(t, e, n, { discrete: r }) {
  ...
  e && s.addEventListener(t, e, { once: !0 }), r ? m2(s, a) : s.dispatchEvent(a);
}
var pf = "focusScope.autoFocusOnMount", mf = "focusScope.autoFocusOnUnmount", i_ = { bubbles: !1, cancelable: !0 }, G2 = "FocusScope", yw = E.forwardRef((t, e) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: s,
    ...
    ...l
  } = t, [c, f] = E.useState(null), m = xs(s), g = xs(a), d = E.useRef(null), p = kt(e, (S) => f(S)), v = E.useRef({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  E.useEffect(() => {
    ...
    if (c) {
      ...
      if (!c.contains(S)) {
        const A = new CustomEvent(pf, i_);
        c.addEventListener(pf, m), c.dispatchEvent(A), A.defaultPrevented || (K2(J2(vw(c)), { select: !0 }), document.activeElement === S && _r(c));
      }
      return () => {
        c.removeEventListener(pf, m), setTimeout(() => {
          const A = new CustomEvent(mf, i_);
          c.addEventListener(mf, g), c.dispatchEvent(A), A.defaultPrevented || _r(S ?? document.body, { select: !0 }), c.removeEventListener(mf, g), o_.remove(v);
        }, 0);
      };
    }
  }, [c, m, g, v]);
  const w = E.useCallback(
    (S) => {
      ...
      if (T && A) {
        const b = S.currentTarget, [C, M] = Y2(b);
...
yw.displayName = G2;
function K2(t, { select: e = !1 } = {}) {
  const n = document.activeElement;
  for (const r of t)
    if (_r(r, { select: e }), document.activeElement !== n) return;
}
function Y2(t) {
  const e = vw(t), n = s_(e, t), r = s_(e.reverse(), t);
  return [n, r];
}
function vw(t) {
...
function _r(t, { select: e = !1 } = {}) {
  if (t && t.focus) {
    const n = document.activeElement;
    t.focus({ preventScroll: !0 }), t !== n && Q2(t) && e && t.select();
  }
}
var o_ = X2();
function X2() {
  ...
  return {
    add(e) {
      const n = t[0];
      e !== n && (n == null || n.pause()), t = a_(t, e), t.unshift(e);
    },
    remove(e) {
      var n;
      t = a_(t, e), (n = t[0]) == null || n.resume();
    }
  };
}
function a_(t, e) {
...
var eD = "Portal", _w = E.forwardRef((t, e) => {
  var c;
...
var sa = (t) => {
  const { present: e, children: n } = t, r = nD(e), s = typeof n == "function" ? n({ present: r.isPresent }) : E.Children.only(n), a = rD(r.ref, iD(s));
  return typeof n == "function" || r.isPresent ? E.cloneElement(s, { ref: a }) : null;
};
sa.displayName = "Presence";
function nD(t) {
  const [e, n] = E.useState(), r = E.useRef(null), s = E.useRef(t), a = E.useRef("none"), l = t ? "mounted" : "unmounted", [c, f] = tD(l, {
    mounted: {
      UNMOUNT: "unmounted",
    ...
    if (s)
      return () => {
        for (let l = 0; l < a.length; l++) {
          const c = a[l];
          typeof c == "function" ? c() : l_(r[l], null);
        }
      };
  }, []);
}
...
var Yl = "right-scroll-bar-position", ql = "width-before-scroll-bar", aD = "with-scroll-bars-hidden", lD = "--removed-body-scroll-bar-size";
function gf(t, e) {
...
var cD = typeof window < "u" ? E.useLayoutEffect : E.useEffect, c_ = /* @__PURE__ */ new WeakMap();
function dD(t, e) {
...
var xD = function() {
  ...
  if (t === void 0 && (t = "margin"), typeof window > "u")
    return wD;
  var e = TD(t), n = document.documentElement.clientWidth, r = window.innerWidth;
  return {
    left: e[0],
    top: e[1],
    right: e[2],
...
}, kD = Tw(), os = "data-scroll-locked", bD = function(t, e, n, r) {
...
`);
  ...
  E.useEffect(function() {
    return document.body.setAttribute(os, (d_() + 1).toString()), function() {
      var t = d_() - 1;
  ...
  return E.createElement(kD, { styles: bD(a, !e, s, n ? "" : "!important") });
}, Ch = !1;
if (typeof window < "u")
  try {
...
var $i = Ch ? { passive: !1 } : !1, ED = function(t) {
  ...
  return (
    ...
    !(n.overflowY === n.overflowX && !ED(t) && n[e] === "visible")
  );
}, MD = function(t) {
  ...
  return t === "v" ? MD(e) : RD(e);
}, bw = function(t, e) {
  return t === "v" ? ND(e) : ID(e);
}, DD = function(t, e) {
  return t === "h" && e === "rtl" ? -1 : 1;
}, jD = function(t, e, n, r, s) {
  var a = DD(t, window.getComputedStyle(e).direction), l = a * r, c = n.target, f = e.contains(c), m = !1, g = l > 0, d = 0, p = 0;
  do {
    if (!c)
      break;
...
function zD(t) {
  var e = E.useRef([]), n = E.useRef([0, 0]), r = E.useRef(), s = E.useState(LD++)[0], a = E.useState(Tw)[0], l = E.useRef(t);
  E.useEffect(function() {
    l.current = t;
  }, [t]), E.useEffect(function() {
    if (t.inert) {
      document.body.classList.add("block-interactivity-".concat(s));
      var S = oD([t.lockRef.current], (t.shards || []).map(p_), !0).filter(Boolean);
  ...
  var c = E.useCallback(function(S, T) {
    if ("touches" in S && S.touches.length === 2 || S.type === "wheel" && S.ctrlKey)
      return !l.current.allowPinchZoom;
    var A = Ml(S), b = n.current, C = "deltaX" in S ? S.deltaX : b[0] - A[0], M = "deltaY" in S ? S.deltaY : b[1] - A[1], P, $ = S.target, I = Math.abs(C) > Math.abs(M) ? "h" : "v";
    ...
    if (!q)
      return !0;
    if (q ? P = I : (P = I === "v" ? "h" : "v", q = f_(I, $)), !q)
      return !1;
    if (!r.current && "changedTouches" in S && (C || M) && (r.current = P), !P)
      return !0;
    var ee = r.current || P;
    return jD(ee, T, S, ee === "h" ? C : M);
  }, []), f = E.useCallback(function(S) {
    var T = S;
    if (!(!Vi.length || Vi[Vi.length - 1] !== a)) {
      var A = "deltaY" in T ? h_(T) : Ml(T), b = e.current.filter(function(P) {
        return P.name === T.type && (P.target === T.target || T.target === P.shadowParent) && FD(P.delta, A);
      })[0];
      if (b && b.should) {
      ...
      if (!b) {
        var C = (l.current.shards || []).map(p_).filter(Boolean).filter(function(P) {
          return P.contains(T.target);
        }), M = C.length > 0 ? c(T, C[0]) : !l.current.noIsolation;
        M && T.cancelable && T.preventDefault();
      }
    }
  }, []), m = E.useCallback(function(S, T, A, b) {
    var C = { name: S, delta: T, target: A, should: b, shadowParent: $D(A) };
    e.current.push(C), setTimeout(function() {
      e.current = e.current.filter(function(M) {
        return M !== C;
      });
    }, 1);
  }, []), g = E.useCallback(function(S) {
    n.current = Ml(S), r.current = void 0;
  }, []), d = E.useCallback(function(S) {
    m(S.type, h_(S), S.target, c(S, t.lockRef.current));
  }, []), p = E.useCallback(function(S) {
  ...
  return E.createElement(
    E.Fragment,
    null,
    w ? E.createElement(a, { styles: OD(s) }) : null,
    v ? E.createElement(PD, { noRelative: t.noRelative, gapMode: t.gapMode }) : null
  );
}
function $D(t) {
...
const VD = mD(ww, zD);
var Cw = E.forwardRef(function(t, e) {
  return E.createElement(zu, Nn({}, t, { ref: e, sideCar: VD }));
});
Cw.classNames = zu.classNames;
var BD = function(t) {
  if (typeof document > "u")
    return null;
  var e = Array.isArray(t) ? t[0] : t;
  return e.ownerDocument.body;
}, Bi = /* @__PURE__ */ new WeakMap(), Rl = /* @__PURE__ */ new WeakMap(), Nl = {}, _f = 0, Pw = function(t) {
  ...
  var s = UD(e, Array.isArray(t) ? t : [t]);
  ...
  var r = Array.from(Array.isArray(t) ? t : [t]), s = BD(t);
  return s ? (r.push.apply(r, Array.from(s.querySelectorAll("[aria-live], script"))), HD(r, s, n, "aria-hidden")) : function() {
    return null;
  };
}, $u = "Dialog", [Ew] = ra($u), [ZD, Sn] = Ew($u), Mw = (t) => {
  const {
    __scopeDialog: e,
    children: n,
    open: r,
    ...
    onOpenChange: a,
    modal: l = !0
  } = t, c = E.useRef(null), f = E.useRef(null), [m, g] = Lu({
    prop: r,
    defaultProp: s ?? !1,
    onChange: a,
    caller: $u
...
Mw.displayName = $u;
var Rw = "DialogTrigger", GD = E.forwardRef(
  (t, e) => {
...
GD.displayName = Rw;
var Up = "DialogPortal", [KD, Nw] = Ew(Up, {
  forceMount: void 0
}), Iw = (t) => {
  const { __scopeDialog: e, forceMount: n, children: r, container: s } = t, a = Sn(Up, e);
  return /* @__PURE__ */ _.jsx(KD, { scope: e, forceMount: n, children: E.Children.map(r, (l) => /* @__PURE__ */ _.jsx(sa, { present: n || a.open, children: /* @__PURE__ */ _.jsx(_w, { asChild: !0, container: s, children: l }) })) });
};
Iw.displayName = Up;
var ku = "DialogOverlay", Dw = E.forwardRef(
  (t, e) => {
    const n = Nw(ku, t.__scopeDialog), { forceMount: r = n.forceMount, ...s } = t, a = Sn(ku, t.__scopeDialog);
    return a.modal ? /* @__PURE__ */ _.jsx(sa, { present: r || a.open, children: /* @__PURE__ */ _.jsx(qD, { ...s, ref: e }) }) : null;
  }
);
Dw.displayName = ku;
var YD = /* @__PURE__ */ Au("DialogOverlay.RemoveScroll"), qD = E.forwardRef(
  (t, e) => {
    const { __scopeDialog: n, ...r } = t, s = Sn(ku, n);
    return (
      // Make sure `Content` is scrollable even when it doesn't live inside `RemoveScroll`
      // ie. when `Overlay` and `Content` are siblings
      /* @__PURE__ */ _.jsx(Cw, { as: YD, allowPinchZoom: !0, shards: [s.contentRef], children: /* @__PURE__ */ _.jsx(
        Je.div,
        {
          "data-state": Wp(s.open),
          ...r,
...
), di = "DialogContent", jw = E.forwardRef(
  (t, e) => {
    const n = Nw(di, t.__scopeDialog), { forceMount: r = n.forceMount, ...s } = t, a = Sn(di, t.__scopeDialog);
    return /* @__PURE__ */ _.jsx(sa, { present: r || a.open, children: a.modal ? /* @__PURE__ */ _.jsx(QD, { ...s, ref: e }) : /* @__PURE__ */ _.jsx(XD, { ...s, ref: e }) });
  }
);
jw.displayName = di;
var QD = E.forwardRef(
  (t, e) => {
    const n = Sn(di, t.__scopeDialog), r = E.useRef(null), s = kt(e, n.contentRef, r);
    return E.useEffect(() => {
      const a = r.current;
      if (a) return WD(a);
    }, []), /* @__PURE__ */ _.jsx(
  ...
  (t, e) => {
    const n = Sn(di, t.__scopeDialog), r = E.useRef(!1), s = E.useRef(!1);
    return /* @__PURE__ */ _.jsx(
      Fw,
      {
        ...t,
  ...
  (t, e) => {
    const { __scopeDialog: n, trapFocus: r, onOpenAutoFocus: s, onCloseAutoFocus: a, ...l } = t, c = Sn(di, n), f = E.useRef(null), m = kt(e, f);
    return sD(), /* @__PURE__ */ _.jsxs(_.Fragment, { children: [
      /* @__PURE__ */ _.jsx(
        yw,
        {
          asChild: !0,
      ...
      /* @__PURE__ */ _.jsxs(_.Fragment, { children: [
        /* @__PURE__ */ _.jsx(JD, { titleId: c.titleId }),
        /* @__PURE__ */ _.jsx(tj, { contentRef: f, descriptionId: c.descriptionId })
      ] })
    ] });
  }
), Hp = "DialogTitle", Ow = E.forwardRef(
  (t, e) => {
...
Ow.displayName = Hp;
var Lw = "DialogDescription", zw = E.forwardRef(
  (t, e) => {
...
zw.displayName = Lw;
var $w = "DialogClose", Vw = E.forwardRef(
  (t, e) => {
...
var Bw = "DialogTitleWarning", [jO, Uw] = QI(Bw, {
  contentName: di,
  titleName: Hp,
  docsSlug: "dialog"
}), JD = ({ titleId: t }) => {
...
}, ej = "DialogDescriptionWarning", tj = ({ contentRef: t, descriptionId: e }) => {
  const r = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${Uw(ej).contentName}}.`;
  return E.useEffect(() => {
    var a;
    const s = (a = t.current) == null ? void 0 : a.getAttribute("aria-describedby");
    e && s && (document.getElementById(e) || console.warn(r));
  }, [r, t, e]), null;
}, Hw = Mw, Ww = Iw, Zw = Dw, Gw = jw, Kw = Ow, Yw = zw, nj = Vw, xf = "rovingFocusGroup.onEntryFocus", rj = { bubbles: !1, cancelable: !0 }, oa = "RovingFocusGroup", [Ph, qw, ij] = G1(oa), [sj, Qw] = ra(
  oa,
  [ij]
), [oj, aj] = sj(oa), Xw = E.forwardRef(
  (t, e) => /* @__PURE__ */ _.jsx(Ph.Provider, { scope: t.__scopeRovingFocusGroup, children: /* @__PURE__ */ _.jsx(Ph.Slot, { scope: t.__scopeRovingFocusGroup, children: /* @__PURE__ */ _.jsx(lj, { ...t, ref: e }) }) })
);
Xw.displayName = oa;
var lj = E.forwardRef((t, e) => {
  const {
    ...
    ...d
  } = t, p = E.useRef(null), v = kt(e, p), w = $p(a), [S, T] = Lu({
    prop: l,
    defaultProp: c ?? null,
    onChange: f,
    caller: oa
  }), [A, b] = E.useState(!1), C = xs(m), M = qw(n), P = E.useRef(!1), [$, I] = E.useState(0);
  return E.useEffect(() => {
    const O = p.current;
    if (O)
      return O.addEventListener(xf, C), () => O.removeEventListener(xf, C);
  }, [C]), /* @__PURE__ */ _.jsx(
    oj,
    {
      scope: n,
...
}), Jw = "RovingFocusGroupItem", eT = E.forwardRef(
  (t, e) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: r = !0,
      ...
      children: l,
      ...c
    } = t, f = Eo(), m = a || f, g = aj(Jw, n), d = g.currentTabStopId === m, p = qw(n), { onFocusableItemAdd: v, onFocusableItemRemove: w, currentTabStopId: S } = g;
    return E.useEffect(() => {
      if (r)
        return v(), () => w();
        ...
        children: /* @__PURE__ */ _.jsx(
          Je.span,
          {
            ...
            onKeyDown: He(t.onKeyDown, (T) => {
              ...
              const A = dj(T, g.orientation, g.dir);
              if (A !== void 0) {
...
var hj = Xw, pj = eT, Vu = "Tabs", [mj] = ra(Vu, [
  Qw
]), nT = Qw(), [gj, Zp] = mj(Vu), rT = E.forwardRef(
  (t, e) => {
    const {
      __scopeTabs: n,
      value: r,
...
rT.displayName = Vu;
var iT = "TabsList", sT = E.forwardRef(
  (t, e) => {
    const { __scopeTabs: n, loop: r = !0, ...s } = t, a = Zp(iT, n), l = nT(n);
    return /* @__PURE__ */ _.jsx(
      hj,
      {
        asChild: !0,
...
sT.displayName = iT;
var oT = "TabsTrigger", aT = E.forwardRef(
  (t, e) => {
    const { __scopeTabs: n, value: r, disabled: s = !1, ...a } = t, l = Zp(oT, n), c = nT(n), f = cT(l.baseId, r), m = dT(l.baseId, r), g = r === l.value;
    return /* @__PURE__ */ _.jsx(
      pj,
      {
        asChild: !0,
...
aT.displayName = oT;
var lT = "TabsContent", uT = E.forwardRef(
  (t, e) => {
    const { __scopeTabs: n, value: r, forceMount: s, children: a, ...l } = t, c = Zp(lT, n), f = cT(c.baseId, r), m = dT(c.baseId, r), g = r === c.value, d = E.useRef(g);
    return E.useEffect(() => {
...
function Mo(t, e) {
  return Ql.has(t) || Ql.set(t, Sj(e)), Ql.get(t);
}
function wf(t, e) {
  var r;
  const n = {
...
function hT({ queryKey: t, queryFn: e, initialData: n }) {
  const r = E.useMemo(() => fT(t), [t]), s = E.useRef(e);
  s.current = e;
  const [a, l] = E.useState(() => Mo(r, n));
  return E.useEffect(() => (l(Mo(r, n)), wj(r, l)), [r]), E.useEffect(() => {
    const c = () => Tj(r, () => s.current());
...
function Cj() {
  ...
  return /* @__PURE__ */ _.jsxs("article", { className: "chat-panel", children: [
    ...
    /* @__PURE__ */ _.jsxs("div", { className: "focus-button-row", children: [
      ...
      bj.map((f) => /* @__PURE__ */ _.jsx(de, { disabled: s, onClick: () => c(f), children: f }, f))
    ] })
  ] });
}
function Pj({ cards: t }) {
  ...
  return /* @__PURE__ */ _.jsxs("article", { className: "study-card liquid-glass-lite", children: [
    ...
    /* @__PURE__ */ _.jsx("p", { children: v === "back" ? jI(g) : DI(g, m) }),
...
const Mj = (t, e) => Ej.ensureRenderableSummary(t, e), m_ = {
  A: "𝔸",
  B: "𝔹",
  C: "ℂ",
  D: "𝔻",
...
function Dj(t) {
  let e = String(t || "");
  return e = e.replace(/\\mathbb\{([A-Za-z])\}/g, (n, r) => m_[r] || r), e = e.replace(/\\mathbb\s+([A-Za-z])/g, (n, r) => m_[r] || r), e = e.replace(/\\(?:operatorname|text|mathrm|mathbf|mathit|textbf|textit)\{([^{}]*)\}/g, "$1"), e = e.replace(/\\(?:left|right|big|Big|bigg|Bigg)\b/g, ""), e = e.replace(/\\[,;:!]\s*/g, " "), e = e.replace(/\\(?:widehat|hat)\{([^{}]+)\}/g, (n, r) => Ui(r, "̂", "hat")).replace(/\\(?:overline|bar)\{([^{}]+)\}/g, (n, r) => Ui(r, "̄", "bar")).replace(/\\(?:vec|overrightarrow)\{([^{}]+)\}/g, (n, r) => Ui(r, "⃗", "vec")).replace(/\\tilde\{([^{}]+)\}/g, (n, r) => Ui(r, "̃", "tilde")).replace(/\\dot\{([^{}]+)\}/g, (n, r) => Ui(r, "̇", "dot")).replace(/\\ddot\{([^{}]+)\}/g, (n, r) => Ui(r, "̈", "ddot")), Object.entries(Rj).sort((n, r) => r[0].length - n[0].length).forEach(([n, r]) => {
    e = e.replace(new RegExp(Ij(n) + "(?![A-Za-z])", "g"), r);
  }), Nj.forEach((n) => {
...
function Oj(t) {
  let e = Lj(Eh(String(t || "")));
  const n = Gp(e);
  return e = Eh(Dj(Mh(n.text))).replace(/sqrt\s*\(\s*([^()\n]+?)\s*\)/gi, "√($1)").replace(/sqrt\s*([0-9A-Za-z]+)/gi, "√($1)"), Mh(n.restore(e));
}
function Jl(t) {
  const e = String(t || "");
...
function Qj(t) {
  const e = qj(Hj(Oj(t))), n = Gp(e.text), r = n.text.split(`
`).map((s) => Nh(s)).join(`
`);
  return e.restore(n.restore(r));
}
const Xj = "https://www.desmos.com/api/v1.11/calculator.js", Jj = "desmos";
let Il = null, eF = 0;
const _T = {
...
function iF(t) {
  ...
  e = e.replace(/\$\$([\s\S]*?)\$\$/g, (P, $) => {
    ...
    return n.push(`\\[${xo(P.replace(/^\\\[/, "").replace(/\\\]$/, ""))}\\]`), $;
  }), e = e.replace(/\\\([\s\S]*?\\\)/g, (P) => {
    const $ = `@@INLINE_MATH_${r.length}@@`;
    return r.push(`\\(${xo(P.replace(/^\\\(/, "").replace(/\\\)$/, ""))}\\)`), $;
  });
  const s = new RegExp(
...
`), l = [];
  ...
  function C(P, $) {
    const I = String(P || "").match(/^@@MATH_BLOCK_(\d+)@@$/);
    if (!I) return "";
    const O = n[Number(I[1])] || "";
    return b(O, $) ? oF(O) : "";
  }
  a.forEach((P, $) => {
    const I = P.trim(), O = a[$ + 1] || "", L = I.match(/^\[\[VISUAL:(\d+)\]\]$/);
    if (!L && I && (p = ""), L) {
      A(), T();
      const U = Number(L[1]), q = "", ee = `index:${U}`;
      if (d.has(U) || q) {
        const ne = U, ie = `index:${ne}`;
        p !== ie && (l.push(nF(U, ne)), p = ie);
      } else
        d.add(U), l.push(tF(U)), p = ee;
      return;
    }
    if (v(P) && w(O)) {
      A(), T();
    ...
    if (!w(P)) {
      ...
      if (m && !v(P) && T(), I.startsWith("@@MATH_BLOCK_"))
        ...
        c && (l.push("</ul>"), c = !1);
        const U = P.match(/^(\d+)\.\s+(.*)$/), q = U ? Number(U[1]) : 1;
        f || (l.push(q > 1 ? `<ol start="${q}">` : "<ol>"), f = !0), l.push(`<li>${U ? U[2] : P.replace(/^\d+\.\s+/, "")}</li>`);
      } else I === "" ? A() : (A(), l.push(`<p>${P}</p>`));
    }
  }), A(), T();
  let M = l.join("");
  return n.forEach((P, $) => {
    M = M.replace(`@@MATH_BLOCK_${$}@@`, P);
  }), r.forEach((P, $) => {
    M = M.replace(`@@INLINE_MATH_${$}@@`, P);
...
function xT(t) {
  let e = wt(sF(t)).replace(/\\left|\\right/g, "").replace(/\\,/g, " ").replace(/\s+/g, " ").trim();
...
function oF(t) {
  const e = xT(t);
  if (!e) return "";
  const n = `desmos-graph-${++eF}`, r = `Interactive Desmos graph for ${cF(e)}`;
  return `
...
function aF() {
  return String(window.SYNAPSE_DESMOS_API_KEY || Jj);
}
function lF() {
  return window.Desmos && typeof window.Desmos.GraphingCalculator == "function" ? Promise.resolve(window.Desmos) : Il || (Il = new Promise((t, e) => {
    ...
    s.src = `${Xj}?apiKey=${encodeURIComponent(aF())}`, s.async = !0, s.dataset.synapseDesmos = "true", s.onload = r, s.onerror = () => e(new Error("Could not load the Desmos API.")), document.head.appendChild(s);
  }), Il);
}
function y_(t, e) {
...
function v_(t = document) {
  ...
  }).catch((n) => y_(e, n)) : Promise.resolve();
}
function uF() {
...
const dF = [
  ...
  ["Exam use", "exam-use"]
]), bu = Array.from(Yp.keys()).sort((t, e) => e.length - t.length).map((t) => t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")).join("|"), __ = new RegExp(`\\[(${bu})\\]`, "g"), x_ = new RegExp(`\\[(${bu})\\]`);
function Ih(t) {
...
function aa(t) {
  return pF(hF(t)).replace(/\s+/g, " ").trim();
}
function es(t) {
  return `<span class="notes-section-chip ${Yp.get(t) || "plain"}">${t}</span>`;
}
function mF(t) {
  const e = aa(t);
  for (const [n, r] of dF)
...
function Zo(t) {
  ...
  return e = e.replace(
    ...
    /<p>([\s\S]*?)<\/p>/g,
    (n, r) => x_.test(r) ? `<p>${r.replace(__, (s, a) => es(a))}</p>` : n
  ), e = e.replace(
    /<li>([\s\S]*?)<\/li>/g,
    (n, r) => x_.test(r) ? `<li>${r.replace(__, (s, a) => es(a))}</li>` : n
  ), e;
}
function yF(t, e) {
  const n = (e || []).filter((a) => Yp.has(a)).map((a) => a.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"));
...
function vF(t, e, n) {
  const r = aa(t.headingInnerHtml), s = mF(r), a = !n || e === 0 ? " open" : "", l = s.length ? `<div class="notes-section-chip-row">${s.map(es).join("")}</div>` : "", c = Zo(t.bodyHtml || "");
  return `
...
function AF(t, e, n) {
  const r = aa(t.headingInnerHtml), s = gF(r), a = xF(r), l = Zo(yF(t.bodyHtml || "", s)), c = !n || e <= 1 || a === "deep-explanation" ? " open" : "", f = TF(t, s), m = wF(a), g = SF(a);
...
function kF(t, e) {
  ...
  const s = n.trim() ? `<section class="professional-mode-title-card">${Zo(n)}</section>` : "", a = r.map((l, c) => AF(l, c, e)).join(`
`);
  return `
...
function bF(t, e = {}) {
  ...
  if (!n) return "";
  if (_F(e.promptMode))
    return kF(n, !!e.collapseSecondary);
  const r = Zo(n), { preludeHtml: s, sections: a } = wT(r);
  if (!a.length) return r;
  const l = !!e.collapseSecondary, c = s.trim() ? `<section class="notes-summary-card">${Zo(s)}</section>` : "", f = a.map((m, g) => vF(m, g, l)).join(`
`);
  return `${c}${c && f ? `
` : ""}${f}`.trim();
}
...
function RF(t) {
  const e = Object.keys((t == null ? void 0 : t.sections) || {}).filter(Boolean), n = PF.map((a) => ({
    ...a,
...
function IF({ highlights: t = [], activeId: e = "", onSelect: n }) {
...
function Af({ mode: t = "materials", materials: e = [], status: n = "ready", error: r = "", onWorkspace: s }) {
  var fe, W, J, Q, F;
  const a = H((D) => D.selectedMaterial), l = H((D) => D.openStudyPanel), c = H((D) => D.askAssistant), f = H((D) => D.setAssistantContext), m = H((D) => D.activeSourceHighlight), g = H((D) => D.selectSourceHighlight), d = H((D) => D.setActiveNoteSection), [p, v] = E.useState(""), [w, S] = E.useState(""), T = E.useRef(null);
  E.useEffect(() => {
    var X;
    if (!a) {
      v(""), S("");
  ...
  const A = E.useMemo(() => {
    if (!a) return "";
    const D = Mj(a.aiSummary, a.sections || {}), X = iF(D);
    return bF(X, {
      promptMode: a.promptMode,
      collapseSecondary: CF()
    });
  }, [a]);
  E.useEffect(() => {
    A && uF();
  }, [A]);
  const b = E.useMemo(() => RF(a), [a]), C = Array.isArray(a == null ? void 0 : a.sourceHighlights) ? a.sourceHighlights : [], M = C.find((D) => D.id === (m == null ? void 0 : m.id)) || C[0] || null, P = ys(a), $ = Wo(a), I = (D) => {
    ...
    const ae = `[data-section-title="${S_(D)}"]`;
    ...
    if (S(ae), g(D, { openPanel: !1 }), D.sectionTitle) {
      ...
      const _e = T.current, ke = `[data-section-title="${S_(D.sectionTitle)}"]`;
  ...
  return /* @__PURE__ */ _.jsxs("section", { className: `study-tool-stack focus-material-layout focus-material-mode-${t}`.trim(), children: [
    ie ? /* @__PURE__ */ _.jsxs("article", { className: "study-card liquid-glass-lite focus-material-meta", children: [
      ...
      /* @__PURE__ */ _.jsxs("div", { className: "focus-material-badges", children: [
        ...
        /* @__PURE__ */ _.jsxs("span", { className: "focus-pill", children: [
          /* @__PURE__ */ _.jsx(rI, { size: 14, "aria-hidden": "true" }),
          " ",
          Object.keys(a.sections || {}).length || a.studyHeadings.length || 1,
          " sections"
        ] }),
        /* @__PURE__ */ _.jsxs("span", { className: "focus-pill", children: [
          /* @__PURE__ */ _.jsx(JN, { size: 14, "aria-hidden": "true" }),
          " ",
          C.length || ((fe = a.sources) == null ? void 0 : fe.length) || ((W = a.sourceItems) == null ? void 0 : W.length) || 0,
          " sources"
        ] })
      ] }),
      /* @__PURE__ */ _.jsx("p", { className: "focus-subtle-copy", children: MF(a) }),
      ...
      /* @__PURE__ */ _.jsxs("div", { className: "focus-action-grid", children: [
        ...
        /* @__PURE__ */ _.jsx(de, { onClick: () => P.length ? l("quiz") : s == null ? void 0 : s(a.materialId || "", "quiz"), children: "Make quiz from this section" }),
    ...
    ce ? /* @__PURE__ */ _.jsxs("article", { className: "study-card liquid-glass-lite focus-source-workbench", children: [
      /* @__PURE__ */ _.jsxs("div", { className: "study-tool-head", children: [
        ...
        /* @__PURE__ */ _.jsxs("span", { className: "focus-pill", children: [
          /* @__PURE__ */ _.jsx(yI, { size: 14, "aria-hidden": "true" }),
          " Direct source"
        ] })
      ] }),
...
function FF({ questions: t }) {
  ...
  return /* @__PURE__ */ _.jsxs("div", { className: "quiz-stack", children: [
    ...
    t.map((l, c) => {
      const f = e[c], m = n[c] || null, g = vs(l), d = typeof f == "string" ? f : "", p = VI(l, f);
      return /* @__PURE__ */ _.jsxs("article", { className: "quiz-card liquid-glass-lite", children: [
        ...
        g.length ? /* @__PURE__ */ _.jsx("div", { className: "focus-button-row", children: g.map((v, w) => /* @__PURE__ */ _.jsx(
          de,
          {
            variant: BI(l, f, w) ? "primary" : "ghost",
            onClick: () => r(c, w),
            children: v
          },
          v
...
function zF({ tab: t, materials: e, materialsStatus: n, materialsError: r, onWorkspace: s }) {
  ...
  if (t === "history")
    return /* @__PURE__ */ _.jsx(OF, { onWorkspace: s });
  if (!a)
    return /* @__PURE__ */ _.jsx("p", { className: "focus-panel-empty", children: "No generated materials yet" });
  if (t === "notes")
    return /* @__PURE__ */ _.jsx(
  ...
  return t === "mindmap" ? /* @__PURE__ */ _.jsxs("article", { className: "study-card liquid-glass-lite", children: [
    ...
    /* @__PURE__ */ _.jsx(jF, { mindMap: a.mindMap }),
  ...
  ] }) : t === "plan" ? /* @__PURE__ */ _.jsx(LF, { onWorkspace: s }) : t === "workspace" ? /* @__PURE__ */ _.jsx(DF, { onWorkspace: s }) : null;
}
        ...
        children: [
          /* @__PURE__ */ _.jsxs("div", { className: "drawer-head", children: [
            /* @__PURE__ */ _.jsxs("div", { children: [
              ...
              /* @__PURE__ */ _.jsx(Kw, { children: n === "materials" ? "Materials Workspace" : Y0(n) }),
            ...
            /* @__PURE__ */ _.jsx(nj, { asChild: !0, children: /* @__PURE__ */ _.jsx(de, { "aria-label": "Close study suite", children: /* @__PURE__ */ _.jsx(F1, { size: 16, "aria-hidden": "true" }) }) })
          ] }),
          /* @__PURE__ */ _.jsxs(yj, { className: "ai-tabs", value: n, onValueChange: s, children: [
            /* @__PURE__ */ _.jsx(vj, { className: "ai-tab-row", "aria-label": "Focus Room study tools", children: vh.map((f) => /* @__PURE__ */ _.jsx(_j, { className: "ai-tab-trigger", value: f, children: Y0(f) }, f)) }),
            vh.map((f) => /* @__PURE__ */ _.jsx(xj, { className: "ai-tab-content", value: f, children: /* @__PURE__ */ _.jsx(
              zF,
              {
                tab: f,
                materials: a,
...
function VF(t) {
  return /* @__PURE__ */ _.jsx($F, { ...t });
}
function BF({ onWorkspace: t, onHistory: e }) {
  ...
  return /* @__PURE__ */ _.jsxs("aside", { className: "session-overview liquid-glass", children: [
    ...
    /* @__PURE__ */ _.jsxs("div", { className: "session-mini-grid", children: [
      ...
      /* @__PURE__ */ _.jsxs("button", { className: "session-mini-card", type: "button", onClick: () => l("plan"), children: [
        /* @__PURE__ */ _.jsx(sI, { size: 16, "aria-hidden": "true" }),
...
function w_({ title: t, kicker: e, children: n }) {
...
function WF({ audioState: t }) {
  const e = H((n) => n.activeDrawer);
  return /* @__PURE__ */ _.jsxs(Xo, { children: [
    e === "scene" ? /* @__PURE__ */ _.jsx(w_, { title: "Choose Scene", kicker: "Scene", children: /* @__PURE__ */ _.jsx(H1, {}) }) : null,
    e === "music" ? /* @__PURE__ */ _.jsx(w_, { title: "Sound Atmosphere", kicker: "Music", children: /* @__PURE__ */ _.jsx(hw, { audioState: t }) }) : null
  ] });
}
var kf = {};
/*!
    ...
    (function() {
      ...
      r.prototype = {
        ...
        play: function(d, p) {
          ...
          var C = Math.max(0, A._seek > 0 ? A._seek : v._sprite[d][0] / 1e3), M = Math.max(0, (v._sprite[d][0] + v._sprite[d][1]) / 1e3 - C), P = M * 1e3 / Math.abs(A._rate), $ = v._sprite[d][0] / 1e3, I = (v._sprite[d][0] + v._sprite[d][1]) / 1e3;
          A._sprite = d, A._ended = !1;
          var O = function() {
        ...
        _startFadeInterval: function(d, p, v, w, S, T) {
          var A = this, b = p, C = v - p, M = Math.abs(C / 0.01), P = Math.max(4, M > 0 ? w / M : w), $ = Date.now();
        ...
        seek: function() {
          ...
          if (A)
            if (typeof v == "number" && v >= 0) {
              ...
              var P = d.playing(w) ? n.ctx.currentTime - A._playStart : 0, $ = A._rateSeek ? A._rateSeek - A._seek : 0;
              return A._seek + ($ + P * Math.abs(A._rate));
            } else
...
var GF = ZF();
const KF = /* @__PURE__ */ I_(GF), { Howl: TT } = KF, Dh = 500, sn = {
  music: null,
...
function Uu(t, { unload: e = !1 } = {}) {
  var n;
  t && (kT(t, 0, Math.min(Dh, 300)), (n = globalThis.setTimeout) == null || n.call(globalThis, () => {
    try {
      t.pause(), e && t.unload();
    } catch {
    }
...
function YF(t) {
  return !(t != null && t.streamUrl) || !Go() ? null : ((!sn.music || sn.music.__synapseSrc !== t.streamUrl) && (Uu(sn.music, { unload: !0 }), sn.music = AT(t.streamUrl), sn.music.__synapseSrc = t.streamUrl), sn.music);
}
function qF(t) {
...
async function JF(t = {}) {
  ...
  if (!No)
    return bT(), eu(e);
  const n = YF(e.musicTrack), r = A_(Zi.musicVolume, 60), s = A_(Zi.ambientVolume, 50), a = /* @__PURE__ */ new Set(), l = [];
  return e.ambientLayers.forEach((c) => {
    const f = c.id || c.streamUrl;
    a.add(f);
    const m = qF(c), g = Math.min(1, Math.max(0, s * (c.volumeBias ?? 1)));
    l.push([m, g]);
  }), XF(a), k_(n, r), l.forEach(([c, f]) => k_(c, f)), eu(e);
}
function eO(t) {
...
const tO = "synapse.focusRoom.audioPrefs.v1";
function nO(t) {
  var e;
  try {
    (e = globalThis.localStorage) == null || e.setItem(tO, JSON.stringify({
      musicType: t.musicType,
      ambientSound: t.ambientSound,
...
function rO() {
  const t = H((c) => c.musicType), e = H((c) => c.ambientSound), n = H((c) => c.musicVolume), r = H((c) => c.ambientVolume), s = H((c) => c.audioPlaying), [a, l] = E.useState(() => eu(Nu({
    musicType: t,
    ambientSound: e
  })));
  return E.useEffect(() => {
...
function iO() {
  const t = H(), e = E.useCallback(async (r = "", s = "", a = {}) => {
    ...
    const l = typeof r == "string" || typeof r == "number" ? r : "", c = typeof s == "string" ? s : "", f = sO(c, a), m = String(l || t.selectedMaterialId || ((g = t.selectedMaterial) == null ? void 0 : g.materialId) || "");
    if (typeof globalThis.returnFromFocusRoomToWorkspace == "function")
      try {
        const d = globalThis.returnFromFocusRoomToWorkspace(m, f);
        d && typeof d.then == "function" && await d, b_(f.action || c, f);
        return;
      } catch (d) {
        console.error("Could not return from Focus Room:", d);
      }
    globalThis.location.hash = "", b_(f.action || c, f);
  }, [t]), n = E.useMemo(() => ({
...
function dO(t) {
  var l;
  const e = kj(), n = H((c) => c.hydrateFocusRoute), r = H((c) => c.showStudyHistory), s = H((c) => c.setMaterialsState), a = uO();
  return E.useEffect(() => {
    const c = () => {
    ...
    const c = cO(a.data, t.materialId);
...
function hO() {
  const [t, e] = E.useState(() => C_());
  E.useEffect(() => {
    const v = () => e(C_());
    return window.addEventListener("hashchange", v), () => window.removeEventListener("hashchange", v);
  }, []);
  const n = E.useMemo(() => RI(t), [t]), r = H((v) => v.view), s = oO(3e3), a = lO(), l = rO(), c = iO();
  dO(n), aO();
  const f = H(Wk(fO)), m = H((v) => v.selectedMaterialId), g = H((v) => v.summaryRecord);
  E.useEffect(() => {
      ...
      children: [
        ...
        /* @__PURE__ */ _.jsx(Xo, { mode: "wait", children: r === "history" ? /* @__PURE__ */ _.jsx(
          cn.div,
          {
            ...
            exit: { opacity: 0, y: -8 },
            transition: is,
            children: /* @__PURE__ */ _.jsx(HF, { onWorkspace: p })
          },
          "history"
          ...
          cn.div,
          {
            ...
            transition: is,
            children: [
              /* @__PURE__ */ _.jsx(j2, { onWorkspace: p, onHistory: d }),
              /* @__PURE__ */ _.jsx("section", { className: "focus-session-stage", children: /* @__PURE__ */ _.jsxs("div", { className: "focus-session-grid", children: [
                /* @__PURE__ */ _.jsx(UF, {}),
                /* @__PURE__ */ _.jsx(D2, {})
              ] }) }),
              /* @__PURE__ */ _.jsx(F2, { audioState: l }),
              /* @__PURE__ */ _.jsx(WF, { audioState: l }),
              /* @__PURE__ */ _.jsx(VF, { onWorkspace: p }),
              /* @__PURE__ */ _.jsx(BF, { onWorkspace: p, onHistory: d })
            ]
          },
          "session"
        ) : /* @__PURE__ */ _.jsx(
          cn.div,
          {
            ...
            exit: { opacity: 0, y: -8 },
            transition: is,
            children: /* @__PURE__ */ _.jsx(R2, { audioState: l, onWorkspace: p, onHistory: d })
          },
          "setup"
        ) })
      ]
...
function gO(t = {}) {
  ...
  bf || (bf = $k.createRoot(e), bf.render(
    Kn.createElement(
      Kn.StrictMode,
      null,
      Kn.createElement(hO)
...
const yO = "synapse.generated.history.v6", PT = "synapse.active.generated.v6", vO = "synapse.flashcards.deck.v1", _O = "synapse.quiz.history.v1", xO = "synapse.focusRoom.return-target.v1";
function qp(t, e) {
  var n;
  try {
...
function kO(t = {}) {
  const e = qp(vO, {}), r = ET(t).map((s) => e == null ? void 0 : e[s]).find((s) => s && Array.isArray(s.cards) && s.cards.length);
...
function PO(t = {}) {
  const e = qp(_O, {}), r = ET(t).flatMap((a) => Array.isArray(e == null ? void 0 : e[a]) ? e[a] : []), s = /* @__PURE__ */ new Set();
  return CO(r).filter((a) => {
    const l = bO(a);
...
function Qp() {
  return TO().filter((t) => t && (t.id || t.summary)).map(EO);
}
function MT(t = "") {
  const e = String(t || "");
...
async function NO(t = "", e = {}) {
  ...
  n && SO(PT, n);
  const r = RO(n, e);
  r.action && wO(xO, r), globalThis.location.href = n ? `index.html?focusReturn=${encodeURIComponent(n)}` : "index.html";
}
function IO() {
  Object.assign(globalThis, {
    ...
    openSynapseFocusRoom: MO,
    returnFromFocusRoomToWorkspace: NO
  });
}
...
if (!NT)
  throw new Error("Focus Room root element was not found.");
var M_;
(M_ = document.getElementById("focusRoomFallbackTitle")) == null || M_.remove();
globalThis.apiClient = new N_(Nk);
IO();
