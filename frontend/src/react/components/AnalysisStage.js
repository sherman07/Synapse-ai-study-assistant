...
import { NotesToolbar } from "./NotesToolbar.js?v=react-shell-v2";
import { SourceViewerPanel } from "./SourceViewerPanel.js?v=react-shell-v2";
import { StudyTools } from "./StudyTools.js?v=react-shell-v2";
