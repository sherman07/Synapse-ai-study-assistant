...
assert.ok(
  focusRoomHtml.includes('import("./src/focus-room/static-compatible-loader.js?v=focus-room-loader-v11")'),
...
assert.ok(
  focusRoomHtml.includes("styles/09-focus-room.css?v=setup-first-v2"),
  "Focus Room HTML should cache-bust the CSS after portal stacking fixes"
);
assert.ok(
  focusRoomHtml.includes("static-compatible-loader.js?v=focus-room-loader-v11"),
...
assert.ok(
  focusRoomStaticLoader.includes("focus-room-static.js?v=focus-room-static-v11"),
